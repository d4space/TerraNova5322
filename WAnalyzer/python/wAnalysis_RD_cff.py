...
WEleNeu = cms.EDFilter('wLeptNeuFilter',
    ...
    #HLTTriggers = cms.untracked.vstring('HLT_Ele22_CaloIdL_CaloIsoVL'),#To make the Ntuple tree happy
...
WMuNeu = cms.EDFilter('wLeptNeuFilter',
    TriggerResultsTag = cms.untracked.InputTag('TriggerResults','','HLT'),
    #HLTTriggers = cms.untracked.vstring('HLT_Mu15_eta2p1','HLT_IsoMu24_eta2p1'),#To make the Ntuple tree happy
    HLTTriggers = cms.untracked.vstring('HLT_Ele22_CaloIdL_CaloIsoVL','HLT_Ele27_WP80','HLT_Mu15_eta2p1'),
    genParticlesLabel = cms.InputTag('genParticles'),
