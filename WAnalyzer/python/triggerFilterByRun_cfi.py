...
SmTriggerFilterByRun = cms.EDFilter("TriggerFilterByRun",
    triggerResults = cms.untracked.InputTag("TriggerResults", "", "HLT"),
    filter = cms.untracked.bool(True),
    filterOutUndefined = cms.untracked.bool(True),
    triggerPSets = cms.untracked.VPSet(
        cms.untracked.PSet(
            runBegin = cms.untracked.int32(190645),
            runEnd = cms.untracked.int32(190645),
            triggerNames = cms.untracked.vstring("HLT_Mu40_eta2p1_*")
        ),
    )
)
