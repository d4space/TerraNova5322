...
//  c1->GetFrame()->GetBorderSize(12);
  ...
  //Float_t y2[n2] ={95.1,94.6,99.2,108,117,125,135,171,186,204,216};
    Float_t y2[n2] ={43.7,43.2,47.9,56.8,66,74.4,84.4,121,136,154,166};
...
*/
  ...
  Float_t y4[n4] ={88,85.5,90,119.2,109.8,118,114.1,158.5,170.1,209.5,209.7};
  ...
  Float_t ey4[n4] ={1.35,1.38,1.3,1.6,1.26,1.29,1.92,2.39,2.44,3.29};
