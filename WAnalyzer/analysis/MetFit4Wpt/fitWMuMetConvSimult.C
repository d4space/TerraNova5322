...
void fitWMuMetConvSimult(const TString  outputDir,   // output directory
...
{
  gBenchmark->Start("fitWMuMetConvSimult");
  ...
  ***********************/
  ...
  fnamev.push_back("../EventSelection/MuonLowPU/Muon_WpToMuNu_S8_Up_RecoilCorr.root"); typev.push_back(eWpMuNu);
  fnamev.push_back("../EventSelection/MuonLowPU/Muon_WmToMuNu_S8_Up_RecoilCorr.root"); typev.push_back(eWmMuNu);
  }else if (filetype == "Down"){
  fnamev.push_back("../EventSelection/MuonLowPU/Muon_WpToMuNu_S8_Down_RecoilCorr.root"); typev.push_back(eWpMuNu);
  fnamev.push_back("../EventSelection/MuonLowPU/Muon_WmToMuNu_S8_Down_RecoilCorr.root"); typev.push_back(eWmMuNu);
...
//  double WptBins[18]={0,2.5,5,7.5,10,12.5,15,17.5,20,30,40,50,70,90,150,190,250,600};
  ...
  TH1D *hDYToMuMu = new TH1D("hDYToMuMu","hDYToMuMu",11,WptBins);hDYToMuMu->Sumw2();
  ...
  TH1D *hDYToMuMuP = new TH1D("hDYToMuMuP","hDYToMuMuP",11,WptBins);hDYToMuMuP->Sumw2();
  ...
  TH1D *hDYToMuMuM = new TH1D("hDYToMuMuM","hDYToMuMuM",11,WptBins);hDYToMuMuM->Sumw2();
...
//W minus pt distribution
  ...
  makeHTML(outputDir);
  gBenchmark->Show("fitWMuMetConvSimult");
}
