...
//Write All Bin Yields Information to txt file
  ...
  for( int ipt(0);ipt<NWptBinPlus;ipt++)
  {
    ...
    if (ipt == 0){
      ...
      nSig[ipt]  -> setVal(13361.6);
      nSigp[ipt] -> setVal(7897.23);
      nSigm[ipt] -> setVal(5470.24);
      nAntiSig[ipt]  -> setVal(82.2103);
      nAntiSigp[ipt] -> setVal(76.9423);
      nAntiSigm[ipt] -> setVal(69.1176);
      nQCD[ipt]  -> setVal(4264.63);
      nQCDp[ipt] -> setVal(2196.8);
      nQCDm[ipt] -> setVal(2084.18);
      nAntiQCD[ipt]  -> setVal(11894);
      nAntiQCDp[ipt] -> setVal(6002.56);
      nAntiQCDm[ipt] -> setVal(5821.69);
      qcdsigma1[ipt] ->setVal(5.34681);
      qcdPsigma1[ipt]->setVal(7.00914);
      qcdMsigma1[ipt]->setVal(6.97026);
      qcda1[ipt] ->setVal(0.233106);
      qcdPa1[ipt]->setVal(0.192593);
      qcdMa1[ipt]->setVal(0.196699);
      dFrac1[ipt] ->setVal(0.0950391);
      dFrac1P[ipt]->setVal(0.442318);
      dFrac1M[ipt]->setVal(0.433093);
      qcdsigma2[ipt] ->setVal(2.08493);
      qcdPsigma2[ipt]->setVal(2.68339);
      qcdMsigma2[ipt]->setVal(2.88296);
      qcda2[ipt] ->setVal(-0.27872);
      qcdPa2[ipt]->setVal(0.223234);
      qcdMa2[ipt]->setVal(0.218741);
      dFrac2[ipt] ->setVal(0.00488965);
      dFrac2P[ipt]->setVal(0.470365);
      dFrac2M[ipt]->setVal(0.489426);
    }else if (ipt == 5){
