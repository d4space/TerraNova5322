...
//Write All Bin Yields Information to txt file
  ...
  for( int ipt(0);ipt<NWptBinPlus;ipt++)
  {
    ...
    if (ipt == 0){
      ...
      nSig[ipt]  -> setVal(13371.7);
      nSigp[ipt] -> setVal(7889.1);
      nSigm[ipt] -> setVal(5473.57);
      nQCD[ipt]  -> setVal(4277.7);
      nQCDp[ipt] -> setVal(2205.9);
      nQCDm[ipt] -> setVal(2080.16);
      nAntiSig[ipt]  -> setVal(155.538);
      nAntiSigp[ipt] -> setVal(51.6646);
      nAntiSigm[ipt] -> setVal(70.3269);
      nAntiQCD[ipt]  -> setVal(13005.5);
      nAntiQCDp[ipt] -> setVal(6633.48);
      nAntiQCDm[ipt] -> setVal(6412.02);
      qcdsigma1[ipt] ->setVal(7.12659);
      qcdPsigma1[ipt]->setVal(1.29358);
      qcdMsigma1[ipt]->setVal(6.98852);
      qcda1[ipt] ->setVal(0.189663);
      qcdPa1[ipt]->setVal(-0.29474);
      qcdMa1[ipt]->setVal(0.194245);
      dFrac1[ipt] ->setVal(0.412468);
      dFrac1P[ipt]->setVal(0.5);
      dFrac1M[ipt]->setVal(0.455658);
      qcdsigma2[ipt] ->setVal(2.94501);
      qcdPsigma2[ipt]->setVal(5.4574);
      qcdMsigma2[ipt]->setVal(2.9791);
      qcda2[ipt] ->setVal(0.218213);
      qcdPa2[ipt]->setVal(0.227878);
      qcdMa2[ipt]->setVal(0.216567);
      dFrac2[ipt] ->setVal(0.499538);
      dFrac2P[ipt]->setVal(0.5);
      dFrac2M[ipt]->setVal(0.486172);
    }else if (ipt == 5){
