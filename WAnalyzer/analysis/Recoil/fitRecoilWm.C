//===============================================================================
//
// Perform fits to recoil against Z->mm events
//
...
//void fitRecoilWm2
void fitRecoilWm(TString infilename,  // input ntuple
...
//Written on WMuNeu.h=============
  ...
  Int_t nbins = sizeof(RecoilBins)/sizeof(Double_t)-1;
  ...
  for(Int_t ibin=0; ibin<nbins; ibin++) {
    sprintf(hname,"hPFu1_%i",ibin);    hPFu1v.push_back(new TH1D(hname,"",100,-100-RecoilBins[ibin],100-RecoilBins[ibin]));    hPFu1v[ibin]->Sumw2();
    sprintf(hname,"hPFu1Bkg_%i",ibin); hPFu1Bkgv.push_back(new TH1D(hname,"",100,-100-RecoilBins[ibin],100-RecoilBins[ibin])); hPFu1Bkgv[ibin]->Sumw2();
...
//    Int_t ipt=-1;
//    for(Int_t ibin=0; ibin<nbins; ibin++) {
//      if(genVPt > RecoilBins[ibin] && genVPt <= RecoilBins[ibin+1]) ipt = ibin;
//    }
//    if(ipt<0) continue;
//  
