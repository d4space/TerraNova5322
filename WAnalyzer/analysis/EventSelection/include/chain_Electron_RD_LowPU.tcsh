#!/bin/tcsh -f
set DIRNAME_Base = $1
set DIRNAME_SMPrompt = "$DIRNAME_Base/SingleElePrompt"
set DIRNAME_SMReReco = "$DIRNAME_Base/SingleEleReReco"
  ...
  echo 'void chain_Electron_RD_LowPU( TChain *chains)'>chain_Electron_RD_LowPU.h
  echo '{'>>chain_Electron_RD_LowPU.h
  foreach fileName ( `ls  $DIRNAME_SMPrompt/*.root `)
    echo $fileName
    echo '  chains->Add("'$fileName'");'>>chain_Electron_RD_LowPU.h
  end
