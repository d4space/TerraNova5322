...
// *** empty log message ***
//
// Revision 1.41  2013/07/03 15:59:47  jungmin
// *** empty log message ***
//
// Revision 1.40  2013/07/03 15:52:45  salee
// *** empty log message ***
//
// Revision 1.39  2013/07/03 15:51:21  salee
// *** empty log message ***
//
// Revision 1.38  2013/07/03 15:46:50  salee
// *** empty log message ***
//
// Revision 1.37  2013/07/03 15:20:00  salee
// *** empty log message ***
//
// Revision 1.36  2013/07/01 13:34:02  salee
// *** empty log message ***
//
//
...
//if(Debug)cout<<"check point 4"<<endl;
    ...
    //Trigger Cut
    //============
    //if(i !=4784738||i !=4661981||i !=3818709||i !=1567909||i !=3000936||i !=4166777)continue;
    ...
    //if( !(i == 4784638 || i == 4661981 || i == 3818709 || i == 1567909 || i == 3000936 || i ==4166777) )continue;
    //Vertex Study===========================
...
if(Debug)cout<<"check point 6-1"<<endl;
	 ...
	 for(int iEtaSD=0;iEtaSD<NWqaBins;iEtaSD++) {
	 if (fabs((*W_Lept1_eta)[iw]) > wqaMetMNBins[iEtaSD] && fabs((*W_Lept1_eta)[iw]) < wqaMetMXBins[iEtaSD] ) {
	 //if (fabs((*W_Lept1_etaSC)[iw]) > wqaMetMNBins[iEtaSD] && fabs((*W_Lept1_etaSC)[iw]) < wqaMetMXBins[iEtaSD] ) {
...
//cout<<"line.NO269, lep eta = "<<fabs(wCand.lep_eta)<<endl;
...
//cout<<"check if&if pt = "<<(*W_Lept1_pt)[iw]<<", event number = "<<i<<", eMulti = "<<wCand.size<<", sigmaIEtaIEta = "<<(*W_Lept1_sigmaIEtaIEta)[iw]<<", dEtaIn = "<<fabs((*W_Lept1_dEtaIn)[iw])<<", dPhiIn = "<<fabs((*W_Lept1_dPhiIn)[iw])<<", HoverE = "<<(*W_Lept1_HoverE)[iw]<<", dxy = "<<fabs((*W_Lept1_dxy)[iw])<<", dz = "<<fabs((*W_Lept1_dz)[iw])<<", InvE-InvP = "<<fabs((*W_Lept1_InvEminusInvP)[iw])<<", mHits = "<<fabs((*W_Lept1_mHits)[iw])<<", lep eta = "<<fabs(wCand.lep_eta)<<", W_Lept1_eta[iw] = "<<(*W_Lept1_eta)[iw]<<", lep SCeta = "<<fabs((*W_Lept1_etaSC)[iw])<<", SideCut pass ="<<ElectronCutSideHighPU(iw)<<", SignalCut pass ="<<ElectronCutHighPU(iw)<<", iw = "<<iw<<endl;
//cout<<"line.NO275, lep eta = "<<fabs(wCand.lep_eta)<<endl;
...
if(Debug)cout<<"check point 6-3"<<endl;
	...
	wCand.lep_eta = (*W_Lept1_eta)[iw];
	  //cout<<"line.NO314, lep eta = "<<fabs(wCand.lep_eta)<<endl;
...
//cout<<"line.NO394, lep eta = "<<fabs(wCand.lep_eta)<<endl;
      //Side Band
...
if(Debug)cout<<"check point 9"<<endl;
	...
	if((*W_Charge)[iw]> 0)	  {
	  ...
	  h1_WpSide_Neu_pt[0]->Fill(wCand.Met_side,TTW);
		//cout<<"check plus electron (before forloop) pt = "<<(*W_Lept1_pt)[iw]<<", event number = "<<i<<", eMulti = "<<wCand.size<<", sigmaIEtaIEta = "<<(*W_Lept1_sigmaIEtaIEta)[iw]<<", dEtaIn = "<<fabs((*W_Lept1_dEtaIn)[iw])<<", dPhiIn = "<<fabs((*W_Lept1_dPhiIn)[iw])<<", HoverE = "<<(*W_Lept1_HoverE)[iw]<<", dxy = "<<fabs((*W_Lept1_dxy)[iw])<<", dz = "<<fabs((*W_Lept1_dz)[iw])<<", InvE-InvP = "<<fabs((*W_Lept1_InvEminusInvP)[iw])<<", mHits = "<<fabs((*W_Lept1_mHits)[iw])<<", lep eta = "<<fabs(wCand.lep_eta)<<", W_Lept1_eta[iw] = "<<(*W_Lept1_eta)[iw]<<", lep SCeta = "<<fabs((*W_Lept1_etaSC)[iw])<<", SideCut pass ="<<ElectronCutSideHighPU(iw)<<", SignalCut pass ="<<ElectronCutHighPU(iw)<<", iw = "<<iw<<endl;
                //cout<<"InitVar4EvtCheck  wCand.Mt = "<<wCand.Mt<<", wCand.lep_phi= "<<wCand.lep_phi<<", wCand.lep_pt= "<<wCand.lep_pt<<endl;
		if(Debug)cout<<"check point 10"<<endl;
//cout<<"line.NO414, lep eta = "<<fabs(wCand.lep_eta)<<", wCand.Met_side = "<<wCand.Met_side<<endl;		
	  ...
	  //if(AnaChannel == "ElectronHighPU") {
		...
		//cout<<"check plus electron pt (bin"<<iEtaSD<<") = "<<(*W_Lept1_pt)[iw]<<", event number = "<<i<<", eMulti = "<<wCand.size<<", sigmaIEtaIEta = "<<(*W_Lept1_sigmaIEtaIEta)[iw]<<", dEtaIn = "<<fabs((*W_Lept1_dEtaIn)[iw])<<", dPhiIn = "<<fabs((*W_Lept1_dPhiIn)[iw])<<", HoverE = "<<(*W_Lept1_HoverE)[iw]<<", dxy = "<<fabs((*W_Lept1_dxy)[iw])<<", dz = "<<fabs((*W_Lept1_dz)[iw])<<", InvE-InvP = "<<fabs((*W_Lept1_InvEminusInvP)[iw])<<", mHits = "<<fabs((*W_Lept1_mHits)[iw])<<", lep eta = "<<fabs(wCand.lep_eta)<<", lep SCeta = "<<fabs((*W_Lept1_etaSC)[iw])<<", SideCut pass ="<<ElectronCutSideHighPU(iw)<<", SignalCut pass ="<<ElectronCutHighPU(iw)<<", iw = "<<iw<<endl;
...
//	  }
   ...
   if(   (ElectronCutSideHighPU(iw)==-1)&&
        ...
        if (fabs((*W_Lept1_eta)[iw]) > wqaMetMNBins[iEtaSD] && fabs((*W_Lept1_eta)[iw]) < wqaMetMXBins[iEtaSD] ) {
        //if (fabs((*W_Lept1_etaSC)[iw]) > wqaMetMNBins[iEtaSD] && fabs((*W_Lept1_etaSC)[iw]) < wqaMetMXBins[iEtaSD] ) {
         //h1_W_Neu_other[iEtaSD]->Fill(wCand.Met,TTW);
         //if(addLepN<2){
	 h1_W_Neu_other[iEtaSD]->Fill((*W_Neut_pt)[iw],TTW);
	 h1_i_other[iEtaSD]->Fill(i);//}
         //cout<<"check pt = "<<(*W_Lept1_pt)[iw]<<", event number = "<<i<<", eMulti = "<<wCand.size<<", sigmaIEtaIEta = "<<(*W_Lept1_sigmaIEtaIEta)[iw]<<", dEtaIn = "<<fabs((*W_Lept1_dEtaIn)[iw])<<", dPhiIn = "<<fabs((*W_Lept1_dPhiIn)[iw])<<", HoverE = "<<(*W_Lept1_HoverE)[iw]<<", dxy = "<<fabs((*W_Lept1_dxy)[iw])<<", dz = "<<fabs((*W_Lept1_dz)[iw])<<", InvE-InvP = "<<fabs((*W_Lept1_InvEminusInvP)[iw])<<", mHits = "<<fabs((*W_Lept1_mHits)[iw])<<", lep eta = "<<fabs(wCand.lep_eta)<<", W_Lept1_eta[iw] = "<<(*W_Lept1_eta)[iw]<<", lep SCeta = "<<fabs((*W_Lept1_etaSC)[iw])<<", SideCut pass ="<<ElectronCutSideHighPU(iw)<<", SignalCut pass ="<<ElectronCutHighPU(iw)<<", iw = "<<iw<<endl;
	}
	}
	}
...
if(Debug)cout<<"check point 16"<<endl;
	...
	//if (fabs((*W_Lept1_etaSC)[iw]) > wqaMetMNBins[iEta] && fabs((*W_Lept1_etaSC)[iw]) < wqaMetMXBins[iEta] ) {
