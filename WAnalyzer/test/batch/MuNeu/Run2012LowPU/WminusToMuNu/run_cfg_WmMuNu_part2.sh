...
#VER=3_6_3
#RUN=$1
set CfgFile=wMuNeuFilter_MC_2012_LowPU_part2_cfg.py
#set CASTORDIR=$2
#echo $CfgFile

set WorkDir=/d2/scratch/khakim/WAnalysis/CMSSW_5_2_6/src/KNUPhy/WAnalyzer/test/batch/MuNeu/Run2012LowPU/WminusToMuNu
