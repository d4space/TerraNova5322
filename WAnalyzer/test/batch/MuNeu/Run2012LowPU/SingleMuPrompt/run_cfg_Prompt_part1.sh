...
#VER=3_6_3
#RUN=$1
set CfgFile=wMuNeuFilter_data_2012APromptV1_part1_cfg.py
#set CASTORDIR=$2
#echo $CfgFile

set WorkDir=/d2/scratch/khakim/WAnalysis/CMSSW_5_2_6/src/KNUPhy/WAnalyzer/test/batch/MuNeu/Run2012LowPU/SingleMuPrompt
#if [ $# -ne 1 ]
#then
...
#source /d2/scratch/khakim/WAnalysis/CMSSW_5_2_5/src/KNUPhy/Miscel/Env/setenv4CMSSW525.tcsh
cmsenv
cmsRun $CfgFile
