...
class MultiObjectCountFilter : public edm::EDFilter
{
public:
  MultiObjectCountFilter(const edm::ParameterSet& pset);
  ~MultiObjectCountFilter() {};
...
MultiObjectCountFilter::MultiObjectCountFilter(const edm::ParameterSet& pset)
{
...
bool MultiObjectCountFilter::filter(edm::Event& event, const edm::EventSetup& eventSetup)
{
...
DEFINE_FWK_MODULE(MultiObjectCountFilter);
