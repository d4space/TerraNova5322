#ifndef Ky_CommonTools_interface_LeptonIsoSelector_h
#define Ky_CommonTools_interface_LeptonIsoSelector_h
...
class LeptonIsoSelector : public Selector<T>  {
 ...
 public: // interface
  ...
  typedef std::map< std::string, KyCombinedIsolation> CombinedIsolations; 
  ...
  const KyCombinedIsolation& combinedIsolation( const char* name ) const {
 ...
 private: 
  ...
  KySpecificIsolation chargedIsoPar_;

  /// parameters for neutral hadron isolation value
  KySpecificIsolation neutralIsoPar_;

  /// parameters for photon isolation value
  KySpecificIsolation photonsIsoPar_;
...
void LeptonIsoSelector<T>::setIsoCut( const edm::ParameterSet& ps ) {
  KyCombinedIsolation combinedIsolation;
