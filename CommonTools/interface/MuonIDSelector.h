#ifndef Ky_CommonTools_interface_MuonIDSelector_h
#define Ky_CommonTools_interface_MuonIDSelector_h
...
//  bool beamSpotCut( const reco::Muon& muon, const Point& position);
 ...
 // bool WMuNucuts( const reco::Muon& muon, const Point& position);
