#ifndef Ky_CommonTools_interface_KySpecificIsolation__
#define Ky_CommonTools_interface_KySpecificIsolation__
...
class KySpecificIsolation {
 ...
 public:
  ...
  friend std::ostream& operator<<(std::ostream& out, const KySpecificIsolation& isoDepParam);
