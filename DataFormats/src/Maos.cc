...
double Ky::mtsq(const TLorentzVector &ptl, const TLorentzVector &qt, double ml, double mchi)
{
...
double Ky::mtsq(const TVector3 &ptl, const TVector3 &qt, double ml, double mchi)
{
    TVector3 l1 = ptl;
    TVector3 l2 = qt;
    l1.SetZ(0.0);
...
#ifndef __MAKECINT__
TLorentzVector Ky::tmpl1_;
TLorentzVector Ky::tmpl2_;
TLorentzVector Ky::tmpmet_;
#endif
...
void minfn(Int_t &npar, Double_t *gin, Double_t &retval, Double_t *par, Int_t iflag){
    ...
    p2 = Ky::tmpmet_ - p1;
    mt12 = Ky::mtsq(Ky::tmpl1_, p1, Ky::tmpl1_.M(), 0.0);
    mt22 = Ky::mtsq(Ky::tmpl2_, p2, Ky::tmpl2_.M(), 0.0);
    // should try swapping
    retval = fmax(mt12, mt22);
}

double Ky::Maos::MT2(const TLorentzVector& metvec, const TLorentzVector &lep1, const TLorentzVector &lep2, double mchi){
...
double Ky::Maos::MAOS(const TLorentzVector& metvec, const TLorentzVector &lep1,const TLorentzVector &lep2, 
