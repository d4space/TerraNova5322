...
'file:/afs/cern.ch/work/s/salee/public/NoPuMET/CMSSW_5_3_9/src/TerraNova/NtupleMaker/NoPUtest/DYJetsToLL/patTuple_skim.root'
...
process.p = cms.Path(
    process.WTauNeuAnalysisMCSequence
)
