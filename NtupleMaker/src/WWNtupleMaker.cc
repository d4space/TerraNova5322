...
#include "TerraNova/NtupleMaker/interface/WWNtupleMaker.h"
...
//    iEvent.getByLabel(edm::InputTag("kt6PFJetsPFlow","rho"), rho);
  ...
  //}
    ...
    iEvent.getByLabel(leptonLabel1_,mu_hand);
    iEvent.getByLabel(leptonLabel2_,ele_hand);
    iEvent.getByLabel(leptonLabel3_,tau_hand);
