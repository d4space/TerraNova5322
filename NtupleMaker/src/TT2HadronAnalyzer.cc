...
#include "TerraNova/NtupleMaker/interface/TT2HadronAnalyzer.h"
#include "DataFormats/PatCandidates/interface/Muon.h"
#include "DataFormats/PatCandidates/interface/MET.h"
void TT2HadronAnalyzer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
...
DEFINE_FWK_MODULE(TT2HadronAnalyzer);
