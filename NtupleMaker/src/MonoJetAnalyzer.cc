...
#include "TerraNova/NtupleMaker/interface/MonoJetAnalyzer.h"
#include "DataFormats/PatCandidates/interface/Muon.h"
#include "DataFormats/PatCandidates/interface/MET.h"
void MonoJetAnalyzer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
...
DEFINE_FWK_MODULE(MonoJetAnalyzer);
