...
#include "TerraNova/NtupleMaker/interface/MonoPhotonAnalyzer.h"
#include "DataFormats/PatCandidates/interface/Muon.h"
#include "DataFormats/PatCandidates/interface/MET.h"
void MonoPhotonAnalyzer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
...
//  cout<<"EAtarget: "<<EAtarget<<endl;
  ...
  iEvent.getByLabel(photonLabel_, photon_hand);
  ...
  LoopPhotons(iEvent, iSetup);

  //ESHandle<SetupData> pSetup;
  //iSetup.get<SetupRecord>().get(pSetup);
  if(EvtPass) tree->Fill();
}
DEFINE_FWK_MODULE(MonoPhotonAnalyzer);
