// $Id: TT2HadronAnalyzer.h,v 1.17 2013/09/13 00:09:33 salee Exp $
//
//
...
#include "TerraNova/NtupleMaker/interface/TT2HadronBranchVars.h"
...
class TT2HadronAnalyzer : public edm::EDAnalyzer{
 public:
  explicit TT2HadronAnalyzer(const edm::ParameterSet& iConfig);
...
TT2HadronAnalyzer::TT2HadronAnalyzer(const edm::ParameterSet& iConfig)
{
...
void TT2HadronAnalyzer::beginJob()
{
...
void TT2HadronAnalyzer::beginRun(const edm::Run& iRun, const edm::EventSetup& iSetup)
{
  //initialization
...
void TT2HadronAnalyzer::bookTree()
{
...
bool TT2HadronAnalyzer::L1TriggerSelection( const edm::Event& iEvent, const edm::EventSetup& iSetup )
{
  // Get L1 Trigger menu
...
void TT2HadronAnalyzer::GetHLTResults(const edm::Event &iEvent, const edm::EventSetup& iSetup)
{
  //Trigger Information----
...
bool TT2HadronAnalyzer::endLuminosityBlock(edm::LuminosityBlock & lumi, const edm::EventSetup & setup)
{
  //cout<<"end lumi "<<endl;
    if(useEventCounter_){
...
bool TT2HadronAnalyzer::checkOverlap(const double & eta, const double & phi, const double & dRval1,const double & reliso1, const double &dRval2, const double & reliso2)
{
  bool overlap = false;
  if( reliso1 < relIso1_ ) {
    overlap = dRval1 < 0.4 ;
...
bool TT2HadronAnalyzer::MatchObjects( const reco::Candidate::LorentzVector& pasObj,
      const reco::Candidate::LorentzVector& proObj,
      bool exact )
{
...
void TT2HadronAnalyzer::LoopJets(const edm::Event &iEvent, const edm::EventSetup& iSetup)
{
    EvtPass = false;
    bool goodVtx=false;
...
void TT2HadronAnalyzer::endJob()
{
}
void TT2HadronAnalyzer::endRun(edm::Run const&, edm::EventSetup const&)
{
}
void TT2HadronAnalyzer::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
void TT2HadronAnalyzer::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
