...
//  lCTree->Draw(lCDraw.str().c_str(),iCCut.c_str());
  ...
  Double_t derr[14] = {0,
    8.57964914235220817e+02, 
    4.88196510951694506e+02,
    2.88144788606126440e+02,
    2.33524928499524520e+02,
    1.45635132142446963e+02,
    1.64585090090276509e+02,
    1.04980854964079640e+02,
    1.24046126830407019e+02,
    7.36904953386739834e+01,
    2.60251237905952095e+01,
    1.38721439830007771e+01,
    1.03734730926659058e+01,
    7.54089948458017645e+00};
...
//  gPad->cd();
  ...
  lC0->SaveAs("WInclmnPt_Result.png");
...
void theoryStudy_test() {
  ...
  std::string WInclenu = "../RstUnfold/Result_WInclToMuNu.root";
