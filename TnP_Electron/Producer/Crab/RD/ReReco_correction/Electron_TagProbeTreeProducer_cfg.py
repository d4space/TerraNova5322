...
#HLTPath = "HLT_Ele22_CaloIdL_CaloIsoVL_v3, HLT_Ele22_CaloIdL_CaloIsoVL_v4"
...
process.pileupReweightingProducer = cms.EDProducer("PileupWeightProducer",
                                ...
                                PileupMCFile = cms.untracked.string("fillrandom.root"),
                                PileupDataFile = cms.untracked.string("fillrandom.root")
)
...
process.source = cms.Source("PoolSource",
	 ...
	 'file:/u/user/knuhamid/PhD_work/Wp-x-section/CMSSW_5_2_6/src/TerraNova/TnP_Electron/Producer/Hammid/MC/DYToEE_5000_copy_1_1_MQr.root',
)
)
