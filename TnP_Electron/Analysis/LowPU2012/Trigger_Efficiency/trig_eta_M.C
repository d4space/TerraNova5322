...
///*
  TFile *f_MC= new TFile("efficiency-mc-WptCutToHLT_eta_M.root","read");
...
//*
  ...
  TFile *f_RD= new TFile("efficiency-data-WptCutToHLT_eta_M.root","read");
...
Lgd->Draw();
 ...
 //grRD->Draw("AP");
 //grMC->Draw("psame");
  myCan->SaveAs("trig_eta_M.png");
  myCan->SaveAs("trig_eta_M.eps");
