...
void trig_et_M()
{
  ...
  gr->Draw("AP");
***************************/
  TFile *f_MC= new TFile("efficiency-mc-WptCutToHLT_et_M.root","read");
...
cout << "YMCerrHi:  " << effMC.getAsymErrorHi() << endl;
 ...
 TFile *f_RD= new TFile("efficiency-data-WptCutToHLT_et_M.root","read");
...
//  myLine->Draw("same");
  myCan->SaveAs("trig_et_M.png");
  myCan->SaveAs("trig_et_M.eps");
