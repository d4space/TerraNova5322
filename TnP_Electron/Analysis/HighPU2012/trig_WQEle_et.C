...
void trig_et_P()
{
  ...
  gr->Draw("AP");
***************************/
  TFile *f_MC= new TFile("efficiency-mc-WCutToHLT_et_P.root","read");
...
cout << "YMCerrHi:  " << effMC.getAsymErrorHi() << endl;
  ...
  grMC->GetXaxis()->SetLimits(0,90);

 TFile *f_RD= new TFile("efficiency-data-WCutToHLT_et_P.root","read");
