...
//*
  TFile *f_MC= new TFile("efficiency-mc-SCToPfElectron_et_M.root","read");
...
TFile *f_RD= new TFile("efficiency-data-SCToPfElectron_et_M.root","read");
...
Lgd->SetFillColor(0);
Lgd->Draw();
grRD->GetXaxis()->SetTitle("E_{T}[Gev]");
//  grRD->Draw("AP");	
  //grMC->Draw("psame");
//  TLine *myLine=new TLine(25,0,25,1);
//  myLine->Draw("same");
  myCan->SaveAs("sc_wptCut_M_et.png");
  myCan->SaveAs("sc_wptCut_M_et.eps");
