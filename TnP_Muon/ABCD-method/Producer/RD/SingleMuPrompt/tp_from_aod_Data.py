...
#process.load("TerraNova.NtupleMaker.Sources.Run2012A_SingleMu_PromptV1_AOD_CP_local_cff")
...
process.tagMuons = cms.EDFilter("PATMuonSelector",
   ...
   # cut = cms.string("pt > 15 && "+MuonIDFlags.WptTight2012withoutIso.value()+" && !triggerObjectMatchesByCollection('hltL3MuonCandidates').empty()"),
)
...
process.probeMuons = cms.EDFilter("PATMuonSelector",
    ...
    #cut = cms.string("track.isNonnull &&"+MuonIDFlags.WptTight2012.value()),  # no real cut now
)
