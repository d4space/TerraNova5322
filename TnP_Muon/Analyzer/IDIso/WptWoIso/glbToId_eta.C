...
void glbToId_eta()
{
  ...
  TFile *f_MCndof2= new TFile("TnP_GlbToID_MCetaplus_WptWoIso_eta.root","read");
  TFile *f_MCndof4= new TFile("TnP_GlbToID_MCetaplus_ndof4_WptWoIso_eta.root","read");

  //TFile *f_MCndof2= new TFile("TnP_GlbToID_MCetaminus_WptWoIso_eta.root","read");
  //TFile *f_MCndof4= new TFile("TnP_GlbToID_MCetaminus_ndof4_WptWoIso_eta.root","read");
  RooDataSet *datasetMC = (RooDataSet*)f_MCndof2->Get("tpTree/WptWoIso_eta/fit_eff");
  ...
  RooDataSet *datasetRD = (RooDataSet*)f_MCndof4->Get("tpTree/WptWoIso_eta/fit_eff");
