...
void glbToId_pt()
{
  ...
  TFile *f_MCndof2= new TFile("TnP_GlbToID_MCptplus_WptWoIso_pt.root","read");
  TFile *f_MCndof4= new TFile("TnP_GlbToID_MCptplus_ndof4_WptWoIso_pt.root","read");
  
  //TFile *f_MCndof2= new TFile("TnP_GlbToID_MCptminus_WptWoIso_pt.root","read");
  //TFile *f_MCndof4= new TFile("TnP_GlbToID_MCptminus_ndof4_WptWoIso_pt.root","read");

  RooDataSet *datasetMC = (RooDataSet*)f_MCndof2->Get("tpTree/WptWoIso_pt/fit_eff");
  ...
  RooDataSet *datasetRD = (RooDataSet*)f_MCndof4->Get("tpTree/WptWoIso_pt/fit_eff");
