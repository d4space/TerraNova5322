...
void glbToId_eta()
{
  ...
  char txtfname[100];
  char histfname[100];
  sprintf(txtfname,"eta_plus");
  sprintf(histfname,"eta_plus.png");
  //sprintf(txtfname,"eta_minus");
  ...
  TFile *f_MCndof2= new TFile("TnP_GlbToID_MCetaplus_WptetaGlb_eta.root","read");
  TFile *f_MCndof4= new TFile("TnP_GlbToID_MCetaplus_ndof4_WptetaGlb_eta.root","read");
  
  TFile *f_MCndof2= new TFile("TnP_GlbToID_MCetaminus_WptetaGlb_eta.root","read");
  TFile *f_MCndof4= new TFile("TnP_GlbToID_MCetaminus_ndof4_WptetaGlb_eta.root","read");
  RooDataSet *datasetMC = (RooDataSet*)f_MCndof2->Get("tpTree/WptetaGlb_eta/fit_eff");
  ...
  RooDataSet *datasetRD = (RooDataSet*)f_MCndof4->Get("tpTree/WptetaGlb_eta/fit_eff");
