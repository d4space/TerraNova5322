...
void glbToId_pt()
{
  ...
  char txtfname[100];
  char histfname[100];
  sprintf(txtfname,"pt_plus.txt",ch);
  sprintf(histfname,"pt_plus.png",ch);
  //sprintf(txtfname,"pt_minus.txt",ch);
  //sprintf(histfname,"pt_minus.png",ch);
  ...
  TFile *f_MCndof2= new TFile("TnP_GlbToID_MCptplus_WptdBdZ_pt.root","read");
  TFile *f_MCndof4= new TFile("TnP_GlbToID_MCptplus_ndof4_WptdBdZ_pt.root","read");
  
  //TFile *f_MCndof2= new TFile("TnP_GlbToID_MCptminus_WptdBdZ_pt.root","read");  
  //TFile *f_MCndof4= new TFile("TnP_GlbToID_MCptminus_ndof4_WptdBdZ_pt.root","read");

  RooDataSet *datasetMC = (RooDataSet*)f_MCndof2->Get("tpTree/WptdBdZ_pt/fit_eff");
  ...
  RooDataSet *datasetRD = (RooDataSet*)f_MCndof4->Get("tpTree/WptdBdZ_pt/fit_eff");
