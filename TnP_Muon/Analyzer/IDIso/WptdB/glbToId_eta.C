...
void glbToId_eta()
{
  ...
  TFile *f_MCndof2= new TFile("TnP_GlbToID_MCetaplus_WptdB_eta.root","read");
  TFile *f_MCndof4= new TFile("TnP_GlbToID_MCetaplus_ndof4_WptdB_eta.root","read");
  
  //TFile *f_MCndof2= new TFile("TnP_GlbToID_MCetaminus_WptdB_eta.root","read");
  //TFile *f_MCndof4= new TFile("TnP_GlbToID_MCetaminus_ndof4_WptdB_eta.root","read");
  RooDataSet *datasetMC = (RooDataSet*)f_MCndof2->Get("tpTree/WptdB_eta/fit_eff");
  ...
  RooDataSet *datasetRD = (RooDataSet*)f_MCndof4->Get("tpTree/WptdB_eta/fit_eff");
