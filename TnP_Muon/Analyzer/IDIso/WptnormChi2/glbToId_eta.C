...
void glbToId_eta()
{
  ...
  TFile *f_MCndof2= new TFile("TnP_GlbToID_MCetaplus_WptnormChi2_eta.root","read");
  TFile *f_MCndof4= new TFile("TnP_GlbToID_MCetaplus_ndof4_WptnormChi2_eta.root","read");
  
  //TFile *f_MCndof2= new TFile("TnP_GlbToID_MCetaminus_WptnormChi2_eta.root","read");
  //TFile *f_MCndof4= new TFile("TnP_GlbToID_MCetaminus_ndof4_WptnormChi2_eta.root","read");
  RooDataSet *datasetMC = (RooDataSet*)f_MCndof2->Get("tpTree/WptnormChi2_eta/fit_eff");
  ...
  RooDataSet *datasetRD = (RooDataSet*)f_MCndof4->Get("tpTree/WptnormChi2_eta/fit_eff");
  ...
  txtfile << "Bins \t MC ndof>2 \t\t\t MC ndof>4 \t\t\t Scale Factor ndof2/ndof4 "  << endl;
  for(int i(0); i<datasetRD->numEntries();i++)
  {
