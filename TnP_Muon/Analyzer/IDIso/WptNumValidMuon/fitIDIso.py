...
Template = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    Categories = cms.PSet(
        ...
        WptNumValidMuon = cms.vstring("WptNumValidMuon", "dummy[pass=1,fail=0]"),
...
#    pt     = cms.vdouble( 5, 10,13, 15, 17, 18, 20, 25, 30, 40, 100 ),
    pt     = cms.vdouble(20,30,40,60,100,250),
...
#    pt  = cms.vdouble(20,30),
#    pt  = cms.vdouble(30,40),
#    pt  = cms.vdouble(40,60),
#    pt  = cms.vdouble(60,100),
#    pt  = cms.vdouble(100,250),
...
PREFIX="/d2/scratch/Storage_Area/Wpt-efficiency/Muon/V8/"
...
#        PREFIX+"tnpZ_MC_DYToMuMu.root",
        PREFIX+"tnpZ_MC_DYToMuMu_ndof4.root",
    ]
else:
  print "Usage: cmsRun %s RD(MC)all_space(eta,pt,vtx)plus(minus)" %sys.argv[1]
  sys.exit(0)
