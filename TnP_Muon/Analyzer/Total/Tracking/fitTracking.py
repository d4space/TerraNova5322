...
ETA_BINS = cms.PSet(CONSTRAINTS,
    ...
    pt = cms.vdouble(20,1000), # full pt range
#    pt = cms.vdouble(20,40),# 1st pt bin
#    pt = cms.vdouble(40,55),# 2nd pt bin
#    pt = cms.vdouble(55,1000),# 3rd pt bin
...
PT_BINS = cms.PSet(CONSTRAINTS,
    ...
    pt = cms.vdouble(20,35,45,60,80), # Zpt pt bins 4
...
process.Template = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    PDFs = cms.PSet(
        voigtPlusExpo = cms.vstring(
            ...
            "Exponential::backgroundPass(mass, lp[0.1,0,5])",
            "Exponential::backgroundFail(mass, lf[0.1,0,5])",
            "efficiency[0.9,0,1]",
...
#REFIX="/terranova_1/W_TnP/Muon/V5/"
