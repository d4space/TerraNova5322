...
Template = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    Variables = cms.PSet(
        mass = cms.vstring("Tag-muon Mass", "60", "120", "GeV/c^{2}"), # Zpt study
        ...
        isGlbMu = cms.vstring("Probe GlobalMuon", "-1", "1", ""),
    ...
    Categories = cms.PSet(
        ...
        WptTight2012  = cms.vstring("WptTight2012", "dummy[pass=1,fail=0]"),
...
#    pt     = cms.vdouble(25,30,35,40,45,50,55,60,65,100,250),
...
#    pt  = cms.vdouble(20,40),
#    pt  = cms.vdouble(40,55),
#   pt  = cms.vdouble(55,1000),
#    eta = cms.vdouble(-2.1,-1.68,-1.26,-0.84,-0.42, 0,0.42,0.84, 1.26, 1.68, 2.1)
#    eta = cms.vdouble(-2.1,-1.6,-1.2,-0.8,-0.4,0,0.4,0.8,1.2,1.6,2.1)
    eta = cms.vdouble(-2.1,-1.2,-0.8,0,0.8,1.2,2.1) #Incl W/Z study
#    eta = cms.vdouble(-2.1,-1.6,-1.2,-0.9,-0.6,-0.3,-0.2,0,0.2,0.3,0.6,0.9,1.2,1.6,2.1) # Zpt eta bins 14
...
process.TnP_GlbToID = Template.clone(
    InputFileNames = cms.vstring(),
    InputTreeName = cms.string("fitter_tree"),
    InputDirectoryName = cms.string("tpTree"),
    OutputFileName = cms.string("TnP_GlbToID_%s.root" % scenario),
...
PREFIX="/d2/scratch/Storage_Area/Wpt-efficiency/Muon_V9_WoDzCut/"
...
if "RD" in scenario:
    process.TnP_GlbToID.InputFileNames = cms.vstring(
        PREFIX+'tnpZ_Data_Run2012LowPU.root',
        #PREFIX+'tnpZ_Data_Run2011B_upTo194479.root',
        #PREFIX+'tnpZ_Data_Run2011B_194480-195016.root',
    )
elif "MC" in scenario:
    process.TnP_GlbToID.InputFileNames = [
...
for ID in IDS:
    ...
    for X,B in ALLBINS:
        ...
        module = process.TnP_GlbToID.clone(OutputFileName = cms.string("TnP_GlbToID_%s_%s_%s.root" % (scenario, ID, X)))
        shape = "voigtPlusExpo"
        #shape = "vpvPlusExpo"
        ...
        setattr(process, "TnP_GlbToID_"+ID+"_"+X, module)        
