...
#include <TLine.h>
#define Nbin 6
void glbToId_eta(const int filetype, const int charge)
{
  if (charge==1)
  char  ch[20] = "plus"; 
  else if (charge==-1)
  ...
  if (filetype==20){
    if (charge==1){
      TFile *f_MC= new TFile("TnP_GlbToID_MCetaplus_20_WptTight2012_eta.root","read");
      TFile *f_RD= new TFile("TnP_GlbToID_RDetaplus_20_WptTight2012_eta.root","read");
    }else if (charge==-1){
      TFile *f_MC= new TFile("TnP_GlbToID_MCetaminus_20_WptTight2012_eta.root","read");
      TFile *f_RD= new TFile("TnP_GlbToID_RDetaminus_20_WptTight2012_eta.root","read");
    }
  }else if (filetype==40){
    if (charge==1){
      TFile *f_MC= new TFile("TnP_GlbToID_MCetaplus_40_WptTight2012_eta.root","read");
      TFile *f_RD= new TFile("TnP_GlbToID_RDetaplus_40_WptTight2012_eta.root","read");
    }else if (charge==-1){
      TFile *f_MC= new TFile("TnP_GlbToID_MCetaminus_40_WptTight2012_eta.root","read");
      TFile *f_RD= new TFile("TnP_GlbToID_RDetaminus_40_WptTight2012_eta.root","read");
    }
  }else if (filetype==55){
    if (charge==1){
      TFile *f_MC= new TFile("TnP_GlbToID_MCetaplus_55_WptTight2012_eta.root","read");
      TFile *f_RD= new TFile("TnP_GlbToID_RDetaplus_55_WptTight2012_eta.root","read");
    }else if (charge==-1){
      TFile *f_MC= new TFile("TnP_GlbToID_MCetaminus_55_WptTight2012_eta.root","read");
      TFile *f_RD= new TFile("TnP_GlbToID_RDetaminus_55_WptTight2012_eta.root","read");
    }
  }else
  if (filetype==1000){
    if (charge==1){
      TFile *f_MC= new TFile("TnP_GlbToID_MCetaplus_WptTight2012_eta.root","read");
      TFile *f_RD= new TFile("TnP_GlbToID_RDetaplus_WptTight2012_eta.root","read");
    }else if (charge==-1){
      TFile *f_MC= new TFile("TnP_GlbToID_MCetaminus_WptTight2012_eta.root","read");
      TFile *f_RD= new TFile("TnP_GlbToID_RDetaminus_WptTight2012_eta.root","read");
    }
  }
...
//  grMC->GetYaxis()->CenterTitle();
  grMC->Draw("AP");

  RooDataSet *datasetRD = (RooDataSet*)f_RD->Get("tpTree/WptTight2012_eta/fit_eff");
