...
process.TnP_Trigger = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    InputFileNames = cms.vstring('tnpZ_Data_Run2012LowPU.root'),
...
PT_BINS  = cms.PSet(CONSTRAINTS,
    ...
    pt = cms.vdouble(20,35,45,55,80),
#    pt = cms.vdouble(25,30,35,40,45,50,55,60,65,80),
...
#    eta = cms.vdouble(-2.1,-1.8,-1.5,-1.2,-0.9,-0.6,-0.3,0,0.3,0.6,0.9,1.2,1.5,1.8,2.1)
    eta = cms.vdouble(-2.1,-1.2,-0.8,0,0.8,1.2,2.1) #Incl W/Z study
#    eta = cms.vdouble(-2.1,-1.6,-1.2,-0.8,-0.4,0,0.4,0.8,1.2,1.6,2.1) #Incl W/Z study
#    eta = cms.vdouble(-2.1,-1.6,-1.2,-0.9,-0.6,-0.3,-0.2,0,0.2,0.3,0.6,0.9,1.2,1.6,2.1) #Zpt study
    )
