#! /bin/bash
#Muon
#INPUTDIR=/terranova_0/W/CMSSW_5_2_6/src/TerraNova/NtupleMaker/analysis/MuNeu/W_Pt/results
INPUTDIR=/u/user/sangilpark/WorkDir/Muon/TerraNova_Nominal/NtupleMaker/analysis/EventSelection/MuonLowPU
...
#Electron scripts
#INPUTDIR=/d2/scratch/knuhamid/Wpt-x-section/CMSSW_5_3_4/src/TerraNova/NtupleMaker/analysis/EventSelection/ElectronLowPU
#INPUTDIR=/d2/scratch/khakim/WAnalysis/CMSSW_5_2_6/src/TerraNova/NtupleMaker/analysis/EventSelection/ElectronLowPU
###                           u1 model(1:single,2:double,3:triple), u2 model, signal only
