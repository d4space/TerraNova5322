...
void fitWMuMetModRayleighSimultFloat(const TString  outputDir,   // output directory
...
{
  gBenchmark->Start("fitWMuMetModRayleighSimultFloat");
...
*/ /*     nSig[ipt]  -> setVal(19361.2);
      ...
      nQCD[ipt]  -> setVal(417.293);
      nQCDp[ipt] -> setVal(229.006);
      nQCDm[ipt] -> setVal(172.546);
      nAntiQCD[ipt]  -> setVal(1654.88);
      nAntiQCDp[ipt] -> setVal(859.297);
      nAntiQCDm[ipt] -> setVal(795.583);
      qcdmean[ipt] ->setVal(13.0857);
      qcdPmean[ipt]->setVal(12.4092);
      qcdMmean[ipt] ->setVal(13.4514);
      qcda1[ipt] ->setVal(0.077171);
      qcdPa1[ipt]->setVal(0.0753291);
      qcdMa1[ipt] ->setVal(0.199203);
      qcdsigma1[ipt] ->setVal(6.09383);
      qcdPsigma1[ipt]->setVal(5.02679);
...
*//*    }else if (ipt == 2){
      ...
      nSigm[ipt] -> setVal(7965.18);
      nAntiSig[ipt]  -> setVal(202.926);
      nAntiSigp[ipt] -> setVal(128.4924);
      nAntiSigm[ipt] -> setVal(74.4336);
      nQCD[ipt]  -> setVal(1167.73);
      nQCDp[ipt] -> setVal(615.895);
      nQCDm[ipt] -> setVal(551.835);
      nAntiQCD[ipt]  -> setVal(3506.19);
      nAntiQCDp[ipt] -> setVal(1757.46);
      nAntiQCDm[ipt] -> setVal(1748.73);
      qcdmean[ipt] ->setVal(7.35995);
      qcdPmean[ipt]->setVal(7.24302);
      qcdMmean[ipt]->setVal(7.36558);
      ...
      nSig[ipt]  -> setVal(15513.1);
      nSigp[ipt] -> setVal(9366.99);
      nSigm[ipt] -> setVal(6146.11);
      nAntiSig[ipt]  -> setVal(339.169);
      nAntiSigp[ipt] -> setVal(195.731);
      nAntiSigm[ipt] -> setVal(143.438);
      nQCD[ipt]  -> setVal(2158.76);
      nQCDp[ipt] -> setVal(1004.6);
      nQCDm[ipt] -> setVal(1154.16);
      nAntiQCD[ipt]  -> setVal(6289.96);
      nAntiQCDp[ipt] -> setVal(3138.1);
      nAntiQCDm[ipt] -> setVal(3151.86);
      qcdmean[ipt] ->setVal(2.39849);
      qcdPmean[ipt]->setVal(2.38088);
      qcdMmean[ipt]->setVal(3.36884);
      qcda1[ipt] ->setVal(0.14289);
      ...
      *//*
      ...
      aqcda1[ipt] ->setVal(0.177631);
      aqcdPa1[ipt]->setVal(0.153052);
      aqcdMa1[ipt]->setVal(0.188629);
      aqcda2[ipt] ->setVal(0.220304);
      aqcdPa2[ipt]->setVal(0.215376);
      aqcdMa2[ipt]->setVal(0.228352);
      ...
      *//*
      ...
      aqcda1[ipt] ->setVal(0.0718333);
      aqcdPa1[ipt]->setVal(0.105133);
      aqcdMa1[ipt]->setVal(0.041951);
      aqcda2[ipt] ->setVal(-0.420624);
      aqcdPa2[ipt]->setVal(-0.419279);
      aqcdMa2[ipt]->setVal(-0.420863);
      ...
      aqcda2[ipt] ->setVal(-0.51328);
      aqcdPa2[ipt]->setVal(-0.527663);
      aqcdMa2[ipt]->setVal(-0.480146);
      aqcdsigma1[ipt] ->setVal(6.47281);
      aqcdPsigma1[ipt]->setVal(6.58175);
      aqcdMsigma1[ipt]->setVal(6.39214);
      aqcdsigma2[ipt] ->setVal(22.2207);
      ...
      aqcda2[ipt] ->setVal(-0.692346);
      aqcdPa2[ipt]->setVal(-0.572614);
      aqcdMa2[ipt]->setVal(-0.71513);
      aqcdsigma1[ipt] ->setVal(8.6167);
      aqcdPsigma1[ipt]->setVal(8.77912);
      aqcdMsigma1[ipt]->setVal(8.6434);
      aqcdsigma2[ipt] ->setVal(37.0122);
      ...
      aqcda2[ipt] ->setVal(-0.99982);
      aqcdPa2[ipt]->setVal(-0.980964);
      aqcdMa2[ipt]->setVal(-1);
      aqcdsigma1[ipt] ->setVal(12.3136);
      aqcdPsigma1[ipt]->setVal(12.1939);
      aqcdMsigma1[ipt]->setVal(12.3985);
      aqcdsigma2[ipt] ->setVal(65.8215);
...
*//*      nSig[ipt]  -> setVal(2542.09);
      ...
      aqcda2[ipt] ->setVal(-0.638364);
      aqcdPa2[ipt]->setVal(-0.630464);
      aqcdMa2[ipt]->setVal(-0.310285);
      aqcdsigma1[ipt] ->setVal(19.461);
      aqcdPsigma1[ipt]->setVal(18.8935);
      aqcdMsigma1[ipt]->setVal(11.1878);
      aqcdsigma2[ipt] ->setVal(68.5899);
...
*/    //}
 ...
 /*     if (ipt>9){
	qcdmean[ipt] ->setVal(4.13158);
        ...
        aqcda2[ipt] ->setVal(-0.196913);
        aqcdPa2[ipt]->setVal(-0.196913);
        aqcdMa2[ipt]->setVal(-0.196913);
        aqcdsigma1[ipt] ->setVal(69.4258);
        aqcdPsigma1[ipt]->setVal(62.7631);
        aqcdMsigma1[ipt]->setVal(71.5588);
        aqcdsigma2[ipt] ->setVal(74.9999);
	...
	//Frac2P[ipt]	->setConstant(kTRUE);
	//Frac2M[ipt]	->setConstant(kTRUE);
	//aqcdmean[ipt]	->setConstant(kTRUE);
	//aqcdPmean[ipt]	->setConstant(kTRUE);
	//aqcdMmean[ipt]	->setConstant(kTRUE);
	//aqcda1[ipt]	->setConstant(kTRUE);
	//aqcdPa1[ipt]	->setConstant(kTRUE);
	//aqcdMa1[ipt]	->setConstant(kTRUE);
	//aqcda2[ipt]	->setConstant(kTRUE);
	//aqcdPa2[ipt]	->setConstant(kTRUE);
	//aqcdMa2[ipt]	->setConstant(kTRUE);
	//aqcdsigma1[ipt]	->setConstant(kTRUE);
	//aqcdPsigma1[ipt]->setConstant(kTRUE);
	//aqcdMsigma1[ipt]->setConstant(kTRUE);
	//aqcdsigma2[ipt]	->setConstant(kTRUE);
...
//W minus pt distribution
  ...
  makeHTML(outputDir);
  gBenchmark->Show("fitWMuMetModRayleighSimultFloat");
}
