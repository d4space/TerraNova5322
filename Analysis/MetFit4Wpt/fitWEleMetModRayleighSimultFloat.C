...
void fitWEleMetModRayleighSimultFloat(const TString  outputDir,   // output directory
...
{
  gBenchmark->Start("fitWEleMetModRayleighSimultFloat");
...
//  double WptBins[18]={0,2.5,5,7.5,10,12.5,15,17.5,20,30,40,50,70,90,150,190,250,600};
  ...
  RooRealVar* aqcda2[NWptBinPlus];
  RooRealVar* aqcdPa2[NWptBinPlus];
  RooRealVar* aqcdMa2[NWptBinPlus];
...
//Write All Bin Yields Information to txt file
  ...
  //for( int ipt(12);ipt<13;ipt++)
  {
    ...
    aqcdPa1[ipt] = new RooRealVar(histName,histName,0.01,-1,1);
    sprintf(histName,"aqcdMa1_%d",ipt);
    aqcdMa1[ipt] = new RooRealVar(histName,histName,0.01,-1,1);

    sprintf(histName,"aqcda2_%d",ipt);
    aqcda2[ipt] = new RooRealVar(histName,histName,0.01,-1,1);
    sprintf(histName,"aqcdPa2_%d",ipt);
    aqcdPa2[ipt] = new RooRealVar(histName,histName,0.01,-1,1);
    sprintf(histName,"aqcdMa2_%d",ipt);
    aqcdMa2[ipt] = new RooRealVar(histName,histName,0.01,-1,1);
    ...
    if (ipt == 0){
      ...
      aqcdmean[ipt] ->setVal(0.0399263);
      aqcdPmean[ipt]->setVal(4.32118e-09);
      aqcdMmean[ipt]->setVal(1.01264e-09);
      aqcdsigma1[ipt] ->setVal(10.7756);
      aqcdPsigma1[ipt]->setVal(10.7471);
      aqcdMsigma1[ipt]->setVal(10.9425);
      aqcda1[ipt] ->setVal(0.14601);
      aqcdPa1[ipt]->setVal(0.147688);
      aqcdMa1[ipt]->setVal(0.142555);
    }else if (ipt == 1){
      nSig[ipt] -> setVal(14470.76);
      nSigp[ipt]-> setVal(8673.77);
      nSigm[ipt]-> setVal(5796.99);
      nAntiSig[ipt] -> setVal(2.10437e-05);
      nAntiSigp[ipt]-> setVal(2.03924e-05);
      nAntiSigm[ipt]-> setVal(5.99258e-07);
      nQCD[ipt] -> setVal(670.767);
      ...
      aqcdmean[ipt] ->setVal(17.1871);
      aqcdPmean[ipt]->setVal(17.2592);
      aqcdMmean[ipt]->setVal(17.0766);
      aqcdsigma1[ipt] ->setVal(11.6833);
      aqcdPsigma1[ipt]->setVal(10.5063);
      aqcdMsigma1[ipt]->setVal(15.0365);
      aqcda1[ipt] ->setVal(0.0437592);
      aqcdPa1[ipt]->setVal(0.0690869);
      aqcdMa1[ipt]->setVal(-0.0442332);
    }else if (ipt == 2){
      ...
      aqcdmean[ipt] ->setVal(12.386);
      aqcdPmean[ipt]->setVal(12.3976);
      aqcdMmean[ipt]->setVal(12.3967);
      aqcdsigma1[ipt] ->setVal(7.116);
      aqcdPsigma1[ipt]->setVal(7.31652);
      aqcdMsigma1[ipt]->setVal(6.70111);
      aqcda1[ipt] ->setVal(0.111568);
      aqcdPa1[ipt]->setVal(0.105727);
      aqcdMa1[ipt]->setVal(0.136719);
    }else if (ipt == 3){
      ...
      aqcdmean[ipt] ->setVal(7.38242);
      aqcdPmean[ipt]->setVal(7.35278);
      aqcdMmean[ipt]->setVal(7.41877);
      aqcdsigma1[ipt] ->setVal(7.71841);
      aqcdPsigma1[ipt]->setVal(7.62938);
      aqcdMsigma1[ipt]->setVal(7.61305);
      aqcda1[ipt] ->setVal(0.119073);
      aqcdPa1[ipt]->setVal(0.126624);
      aqcdMa1[ipt]->setVal(0.125783);
    }else if (ipt == 4){
      nSig[ipt] -> setVal(10753.9);
      nSigp[ipt]-> setVal(6302.72);
      nSigm[ipt]-> setVal(4434.86);
      nAntiSig[ipt] -> setVal(14.3793);
      nAntiSigp[ipt]-> setVal(20.6915);
      nAntiSigm[ipt]-> setVal(1.96049e-05);
      nQCD[ipt] -> setVal(6702.36);
      nQCDp[ipt]-> setVal(3409.96);
      nQCDm[ipt]-> setVal(3311.01);
      nAntiQCD[ipt] -> setVal(5515.52);
      nAntiQCDp[ipt]-> setVal(2811.42);
      nAntiQCDm[ipt]-> setVal(2697);
      qcdmean[ipt] ->setVal(5.46999);
      qcdPmean[ipt]->setVal(5.54601);
      qcdMmean[ipt]->setVal(5.65277);
      qcdsigma1[ipt] ->setVal(4.4329);
      qcdPsigma1[ipt]->setVal(4.39185);
      ...
      aqcdmean[ipt] ->setVal(5.46999);
      aqcdPmean[ipt]->setVal(5.54601);
      aqcdMmean[ipt]->setVal(5.65277);
      aqcdsigma1[ipt] ->setVal(4.4329);
      aqcdPsigma1[ipt]->setVal(4.39185);
      aqcdMsigma1[ipt]->setVal(5.30044);
      aqcda1[ipt] ->setVal(0.222467);
      aqcdPa1[ipt]->setVal(0.214281);
      aqcdMa1[ipt]->setVal(0.221573);
      aqcdsigma2[ipt] ->setVal(8.42163);
      aqcdPsigma2[ipt]->setVal(8.60402);
      aqcdMsigma2[ipt]->setVal(5.55646);
      aqcda2[ipt] ->setVal(0.149918);
      aqcdPa2[ipt]->setVal(0.150846);
      aqcdMa2[ipt]->setVal(0.140031);
      aFrac1[ipt] ->setVal(0.678958);
      aFrac1P[ipt]->setVal(0.0254109);
      aFrac1M[ipt]->setVal(0.597756);
      aFrac2[ipt] ->setVal(0.300864);
      aFrac2P[ipt]->setVal(0.893735);
      aFrac2M[ipt]->setVal(0.456884);
    }else if (ipt == 5){
      nSig[ipt] -> setVal(6041.33);
      nSigp[ipt]-> setVal(3562.2);
      nSigm[ipt]-> setVal(2460.3);
      nAntiSig[ipt] -> setVal(9.90583e-07);
      nAntiSigp[ipt]-> setVal(0.00266521);
      nAntiSigm[ipt]-> setVal(4.84586e-08);
      nQCD[ipt] -> setVal(9564.79);
      nQCDp[ipt]-> setVal(4879.61);
      nQCDm[ipt]-> setVal(4707.63);
      nAntiQCD[ipt] -> setVal(6777.96);
      nAntiQCDp[ipt]-> setVal(3416.76);
      nAntiQCDm[ipt]-> setVal(3361);
      ...
      aqcda1[ipt] ->setVal(-0.272349);
      aqcdPa1[ipt]->setVal(-0.266754);
      aqcdMa1[ipt]->setVal(-0.273361);
      adFrac1[ipt] ->setVal(0.479271);
      adFrac1P[ipt]->setVal(0.5);
      adFrac1M[ipt]->setVal(0.44892);
      aqcdsigma2[ipt] ->setVal(6.76098);
      aqcdPsigma2[ipt]->setVal(6.56927);
      aqcdMsigma2[ipt]->setVal(6.8319);
      aqcda2[ipt] ->setVal(0.200897);
      aqcdPa2[ipt]->setVal(0.205516);
      aqcdMa2[ipt]->setVal(0.198893);
      adFrac2[ipt] ->setVal(0.477855);
      adFrac2P[ipt]->setVal(0.5);
      adFrac2M[ipt]->setVal(0.5);
    }else if (ipt == 6){
      nSig[ipt] -> setVal(5955.6);
      nSigp[ipt]-> setVal(3596.2);
      nSigm[ipt]-> setVal(2359.4);
      nAntiSig[ipt] -> setVal(1.7872);
      nAntiSigp[ipt]-> setVal(1.79112);
      nAntiSigm[ipt]-> setVal(1.62222e-07);
      nQCD[ipt] -> setVal(16030.43);
      ...
      aqcda1[ipt] ->setVal(-0.426312);
      aqcdPa1[ipt]->setVal(0.110942);
      aqcdMa1[ipt]->setVal(0.143796);
      adFrac1[ipt] ->setVal(0.5);
      adFrac1P[ipt]->setVal(0.294399);
      adFrac1M[ipt]->setVal(0.5);
      aqcdsigma2[ipt] ->setVal(9.81148);
      aqcdPsigma2[ipt]->setVal(15.2015);
      aqcdMsigma2[ipt]->setVal(16.68);
      aqcda2[ipt] ->setVal(0.130821);
      aqcdPa2[ipt]->setVal(-0.324381);
      aqcdMa2[ipt]->setVal(-0.463181);
      adFrac2[ipt] ->setVal(0.5);
      adFrac2P[ipt]->setVal(0.4979);
      adFrac2M[ipt]->setVal(0.499997);
    }else if (ipt == 7){
      ...
      aqcda1[ipt] ->setVal(-0.563342);
      aqcdPa1[ipt]->setVal(-0.299181);
      aqcdMa1[ipt]->setVal(-0.664296);
      adFrac1[ipt] ->setVal(0.0205096);
      adFrac1P[ipt]->setVal(0.0315425);
      adFrac1M[ipt]->setVal(0.5);
      aqcdsigma2[ipt] ->setVal(31.0753);
      aqcdPsigma2[ipt]->setVal(29.9725);
      aqcdMsigma2[ipt]->setVal(18.562);
      aqcda2[ipt] ->setVal(-0.63675);
      aqcdPa2[ipt]->setVal(-0.604079);
      aqcdMa2[ipt]->setVal(-0.0610386);
      adFrac2[ipt] ->setVal(0.457178);
      adFrac2P[ipt]->setVal(0.499232);
      adFrac2M[ipt]->setVal(0.5);
    }else if (ipt == 8){
      ...
      aqcda1[ipt] ->setVal(-0.500541);
      aqcdPa1[ipt]->setVal(-0.446264);
      aqcdMa1[ipt]->setVal(-0.596923);
      adFrac1[ipt] ->setVal(0.5);
      adFrac1P[ipt]->setVal(0.499995);
      adFrac1M[ipt]->setVal(0.393532);
      aqcdsigma2[ipt] ->setVal(12.6948);
      aqcdPsigma2[ipt]->setVal(13.3255);
      aqcdMsigma2[ipt]->setVal(12.0182);
      aqcda2[ipt] ->setVal(0.164526);
      aqcdPa2[ipt]->setVal(0.15779);
      aqcdMa2[ipt]->setVal(0.166378);
      adFrac2[ipt] ->setVal(0.26639);
      adFrac2P[ipt]->setVal(0.0899833);
      adFrac2M[ipt]->setVal(0.5);
    }else if (ipt == 9){
      ...
      aqcda1[ipt] ->setVal(-0.139205);
      aqcdPa1[ipt]->setVal(0.0255663);
      aqcdMa1[ipt]->setVal(-0.30412);
      adFrac1[ipt] ->setVal(0.5);
      adFrac1P[ipt]->setVal(0.499956);
      adFrac1M[ipt]->setVal(0.499995);
      aqcdsigma2[ipt] ->setVal(24.5268);
      aqcdPsigma2[ipt]->setVal(22.4994);
      aqcdMsigma2[ipt]->setVal(26.54);
      aqcda2[ipt] ->setVal(0.0121803);
      aqcdPa2[ipt]->setVal(0.0457006);
      aqcdMa2[ipt]->setVal(-0.024091);
      adFrac2[ipt] ->setVal(0.5);
      adFrac2P[ipt]->setVal(0.499998);
      adFrac2M[ipt]->setVal(0.499995);
    }else if (ipt == 10){
      nSig[ipt] -> setVal(561.558);
      ...
      nQCD[ipt] -> setVal(387.482);
      nQCDp[ipt]-> setVal(171.093);
      nQCDm[ipt]-> setVal(232.384);
      nAntiQCD[ipt] -> setVal(221.908);
      ...
      aqcda1[ipt] ->setVal(-0.303623);
      aqcdPa1[ipt]->setVal(-0.283267);
      aqcdMa1[ipt]->setVal(-0.313617);
      adFrac1[ipt] ->setVal(0.5);
      adFrac1P[ipt]->setVal(0.5);
      adFrac1M[ipt]->setVal(0.477816);
      aqcdsigma2[ipt] ->setVal(15.283);
      aqcdPsigma2[ipt]->setVal(16.051);
      aqcdMsigma2[ipt]->setVal(15.8383);
      aqcda2[ipt] ->setVal(0.162499);
      aqcdPa2[ipt]->setVal(0.118942);
      aqcdMa2[ipt]->setVal(0.228386);
      adFrac2[ipt] ->setVal(0.5);
      adFrac2P[ipt]->setVal(0.5);
      adFrac2M[ipt]->setVal(0.487604);
    }else if (ipt == 11){
      ...
      aqcda1[ipt] ->setVal(-0.280424);
      aqcdPa1[ipt]->setVal(-0.278688);
      aqcdMa1[ipt]->setVal(-0.281934);
      adFrac1[ipt] ->setVal(0.4976205);
      adFrac1P[ipt]->setVal(0.5);
      adFrac1M[ipt]->setVal(0.499999);
      aqcdsigma2[ipt] ->setVal(16.0165);
      aqcdPsigma2[ipt]->setVal(17.8307);
      aqcdMsigma2[ipt]->setVal(15.8982);
      aqcda2[ipt] ->setVal(0.248564);
      aqcdPa2[ipt]->setVal(0.102558);
      aqcdMa2[ipt]->setVal(0.248447);
      adFrac2[ipt] ->setVal(0.49994);
      adFrac2P[ipt]->setVal(0.5);
      adFrac2M[ipt]->setVal(0.499999);
    }else if (ipt == 12){
      ...
      aqcda1[ipt] ->setVal(0.281856);
      aqcdPa1[ipt]->setVal(0.289049);
      aqcdMa1[ipt]->setVal(0.283406);
      adFrac1[ipt] ->setVal(0.433415);
      adFrac1P[ipt]->setVal(0.433415);
      adFrac1M[ipt]->setVal(0.499978);
      aqcdsigma2[ipt] ->setVal(15.2418);
      aqcdPsigma2[ipt]->setVal(15.9374);
      aqcdMsigma2[ipt]->setVal(15.6185);
      aqcda2[ipt] ->setVal(0.159594);
      aqcdPa2[ipt]->setVal(0.15815);
      aqcdMa2[ipt]->setVal(0.14915);
      adFrac2[ipt] ->setVal(0.499865);
      adFrac2P[ipt]->setVal(0.46938);
      adFrac2M[ipt]->setVal(0.499995);
    }else if (ipt == 13){
      nSig[ipt] -> setVal(35.2164);
      nSigp[ipt]-> setVal(17.0433);
      nSigm[ipt]-> setVal(15.8052);
      nAntiSig[ipt] -> setVal(1.00015e-06);
      nAntiSigp[ipt]-> setVal(6.63031e-07);
      nAntiSigm[ipt]-> setVal(7.71522e-08);
      nQCD[ipt] -> setVal(40.7157);
      nQCDp[ipt]-> setVal(28.4621);
      nQCDm[ipt]-> setVal(15.3835);
      ...
      aqcda1[ipt] ->setVal(-0.314078);
      aqcdPa1[ipt]->setVal(-0.278158);
      aqcdMa1[ipt]->setVal(-0.386199);
      adFrac1[ipt] ->setVal(0.499997);
      adFrac1P[ipt]->setVal(0.5);
      adFrac1M[ipt]->setVal(0.048127);
      aqcdsigma2[ipt] ->setVal(14.5731);
      aqcdPsigma2[ipt]->setVal(15.9764);
      aqcdMsigma2[ipt]->setVal(8.06314);
      aqcda2[ipt] ->setVal(0.170593);
      aqcdPa2[ipt]->setVal(0.132836);
      aqcdMa2[ipt]->setVal(0.267273);
      adFrac2[ipt] ->setVal(0.5);
      adFrac2P[ipt]->setVal(0.499998);
      adFrac2M[ipt]->setVal(0.391545);
    }
    ...
    if (ipt<4){
      ...
      aqcd1[ipt]  = new CPepePlusMod(histName,pfmet,aqcdmean[ipt], aqcdsigma1[ipt], aqcda1[ipt], aFrac1[ipt], aqcdsigma2[ipt], aqcda2[ipt], aFrac2[ipt]);
      sprintf(histName,"aqcd1p_%d",ipt);
      aqcd1p[ipt] = new CPepePlusMod(histName,pfmet,aqcdPmean[ipt],aqcdPsigma1[ipt],aqcdPa1[ipt],aFrac1P[ipt],aqcdPsigma2[ipt],aqcdPa2[ipt],aFrac2P[ipt]);
      sprintf(histName,"aqcd1m_%d",ipt);
      aqcd1m[ipt] = new CPepePlusMod(histName,pfmet,aqcdMmean[ipt],aqcdMsigma1[ipt],aqcdMa1[ipt],aFrac1M[ipt],aqcdMsigma2[ipt],aqcdMa2[ipt],aFrac2M[ipt]);
...
//W minus pt distribution
  ...
  makeHTML(outputDir);
  gBenchmark->Show("fitWEleMetModRayleighSimultFloat");
}
