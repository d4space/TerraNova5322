 ...
 */   }else if (ipt == 5){
      ...
      aqcdsigma1[ipt]->setVal(1.25411);
      aqcdPsigma1[ipt]->setVal(1.25411);
      aqcdMsigma1[ipt]->setVal(1.25411);
      //aqcdsigma2[ipt] ->setVal(6.76098);
      //aqcdPsigma2[ipt]->setVal(6.56927);
      aqcdsigma2[ipt]->setVal(6.8319);
      aqcdPsigma2[ipt]->setVal(6.8319);
...
*/    }else if (ipt == 12){
      ...
      nAntiSig[ipt] -> setVal(3.16673e-07);
...
*/
    ...
    if (ipt<4){
      ...
      aqcd1[ipt]  = new CPepePlusMod(histName,pfmet,qcd1[ipt]->m1, aqcdsigma1[ipt], aqcda1[ipt], qcd1[ipt]->f1, aqcdsigma2[ipt], aqcda2[ipt], qcd1[ipt]->f2);
      sprintf(histName,"aqcd1p_%d",ipt);                                                                                                                    
      aqcd1p[ipt] = new CPepePlusMod(histName,pfmet,qcd1p[ipt]->m1,aqcdPsigma1[ipt],aqcdPa1[ipt],qcd1p[ipt]->f1,aqcdPsigma2[ipt],aqcdPa2[ipt],qcd1p[ipt]->f2);
      sprintf(histName,"aqcd1m_%d",ipt);                                                                                                                    
      aqcd1m[ipt] = new CPepePlusMod(histName,pfmet,qcd1m[ipt]->m1,aqcdMsigma1[ipt],aqcdMa1[ipt],qcd1m[ipt]->f1,aqcdMsigma2[ipt],aqcdMa2[ipt],qcd1m[ipt]->f2);
	...
	nAntiSigm[ipt]->setVal(0);
      ...
      aqcd2[ipt]  = new CPepeDouble(histName,pfmet,aqcdsigma1[ipt], aqcda1[ipt], qcd2[ipt]->frac1, aqcdsigma2[ipt], aqcda2[ipt], qcd2[ipt]->frac2);
      sprintf(histName,"aqcd2p_%d",ipt);                                                                                                    
      aqcd2p[ipt] = new CPepeDouble(histName,pfmet,aqcdPsigma1[ipt],aqcdPa1[ipt],qcd2p[ipt]->frac1,aqcdPsigma2[ipt],aqcdPa2[ipt],qcd2p[ipt]->frac2);
      sprintf(histName,"aqcd2m_%d",ipt);                                                                                                    
      aqcd2m[ipt] = new CPepeDouble(histName,pfmet,aqcdMsigma1[ipt],aqcdMa1[ipt],qcd2m[ipt]->frac1,aqcdMsigma2[ipt],aqcdMa2[ipt],qcd2m[ipt]->frac2);
