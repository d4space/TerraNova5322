...
void fitWEleMetModRayleighSimult_V3(const TString  outputDir,   // output directory
...
{
  gBenchmark->Start("fitWEleMetModRayleighSimult_V3");
...
//Write All Bin Yields Information to txt file
  ...
  //for( int ipt(11);ipt<12;ipt++)
  {
    ...
    //Initial Values
    if(ipt == 0){
      nSig[ipt] -> setVal(74672.1);
      nSigp[ipt]-> setVal(43863);
      nSigm[ipt]-> setVal(30831.7);
      nAntiSig[ipt] -> setVal(19.8031);
      nAntiSigp[ipt]-> setVal(28.1404);
      nAntiSigm[ipt]-> setVal(12.9602);
      nQCD[ipt] -> setVal(56571.1);
      nQCDp[ipt]-> setVal(28818.7);
      nQCDm[ipt]-> setVal(27718.9);
      nAntiQCD[ipt] -> setVal(42492.3);
      nAntiQCDp[ipt]-> setVal(21909.4);
      nAntiQCDm[ipt]-> setVal(20563.2);
      qcdmean[ipt] ->setVal(0.0436027);
      qcdPmean[ipt]->setVal(1.63816e-10);
      qcdMmean[ipt]->setVal(1.56669e-07);
      qcdsigma1[ipt] ->setVal(10.7032);
      qcdPsigma1[ipt]->setVal(10.771);
      qcdMsigma1[ipt]->setVal(10.9097);
      qcda1[ipt] ->setVal(0.137099);
      qcdPa1[ipt]->setVal(0.135383);
      qcdMa1[ipt]->setVal(0.131524);
      aqcdsigma1[ipt] ->setVal(11.1665);
      aqcdPsigma1[ipt]->setVal(11.2225);
      aqcdMsigma1[ipt]->setVal(11.396);
    }else if (ipt == 1){
      nSig[ipt] -> setVal(14487.3);
      nSigp[ipt]-> setVal(8698.18);
      nSigm[ipt]-> setVal(5789.12);
      nAntiSig[ipt] -> setVal(1.49255e-07);
      nAntiSigp[ipt]-> setVal(4.99353e-08);
      nAntiSigm[ipt]-> setVal(9.93197e-08);
      nQCD[ipt] -> setVal(666.077);
      nQCDp[ipt]-> setVal(314.185);
      nQCDm[ipt]-> setVal(351.892);
      nAntiQCD[ipt] -> setVal(527);
      nAntiQCDp[ipt]-> setVal(300.003);
      nAntiQCDm[ipt]-> setVal(226.997);
      qcdmean[ipt] ->setVal(17.1875);
      qcdPmean[ipt]->setVal(17.1824);
      qcdMmean[ipt]->setVal(17.0758);
      qcdsigma1[ipt] ->setVal(11.6841);
      qcdPsigma1[ipt]->setVal(11.6667);
      qcdMsigma1[ipt]->setVal(15.0131);
      qcda1[ipt] ->setVal(0.0432553);
      qcdPa1[ipt]->setVal(0.0432716);
      qcdMa1[ipt]->setVal(-0.0439593);
      aqcdsigma1[ipt] ->setVal(9.98216);
      aqcdPsigma1[ipt]->setVal(10.0252115);
      aqcdMsigma1[ipt]->setVal(11.395);
    }else if (ipt == 2){
      nSig[ipt] -> setVal(15361.4);
      nSigp[ipt]-> setVal(8964.74);
      nSigm[ipt]-> setVal(6390.54);
      nAntiSig[ipt] -> setVal(75.2757);
      nAntiSigp[ipt]-> setVal(43.4527);
      nAntiSigm[ipt]-> setVal(34.9497);
      nQCD[ipt] -> setVal(924.576);
      nQCDp[ipt]-> setVal(494.187);
      nQCDm[ipt]-> setVal(435.332);
      nAntiQCD[ipt] -> setVal(1121.42);
      nAntiQCDp[ipt]-> setVal(533.904);
      nAntiQCDm[ipt]-> setVal(583.271);
      qcdmean[ipt] ->setVal(12.394);
      qcdPmean[ipt]->setVal(12.4007);
      qcdMmean[ipt]->setVal(12.3925);
      qcdsigma1[ipt] ->setVal(6.99036);
      qcdPsigma1[ipt]->setVal(7.04434);
      qcdMsigma1[ipt]->setVal(7.08695);
      qcda1[ipt] ->setVal(0.124415);
      qcdPa1[ipt]->setVal(0.137525);
      qcdMa1[ipt]->setVal(0.0998612);
      aqcdsigma1[ipt] ->setVal(7.863);
      aqcdPsigma1[ipt]->setVal(7.25377);
      aqcdMsigma1[ipt]->setVal(8.63414);
    }else if (ipt == 3){
      nSig[ipt] -> setVal(12138.5);
      nSigp[ipt]-> setVal(7238.13);
      nSigm[ipt]-> setVal(4901.03);
      nAntiSig[ipt] -> setVal(54.6466);
      nAntiSigp[ipt]-> setVal(39.2165);
      nAntiSigm[ipt]-> setVal(15.144);
      nQCD[ipt] -> setVal(2428.4);
      nQCDp[ipt]-> setVal(1209.57);
      nQCDm[ipt]-> setVal(1218.17);
      nAntiQCD[ipt] -> setVal(2292.68);
      nAntiQCDp[ipt]-> setVal(1117.97);
      nAntiQCDm[ipt]-> setVal(1174.83);
      qcdmean[ipt] ->setVal(7.38292);
      qcdPmean[ipt]->setVal(7.35232);
      qcdMmean[ipt]->setVal(7.41794);
      qcdsigma1[ipt] ->setVal(7.69552);
      qcdPsigma1[ipt]->setVal(7.68914);
      qcdMsigma1[ipt]->setVal(7.68334);
      qcda1[ipt] ->setVal(0.122238);
      qcdPa1[ipt]->setVal(0.121875);
      qcdMa1[ipt]->setVal(0.1232);
      aqcdsigma1[ipt] ->setVal(8.75228);
      aqcdPsigma1[ipt]->setVal(8.86894);
      aqcdMsigma1[ipt]->setVal(8.62685);
    }else if (ipt == 4){
      nSig[ipt] -> setVal(10748.5);
      nSigp[ipt]-> setVal(6296.99);
      nSigm[ipt]-> setVal(4366.15);
      nAntiSig[ipt] -> setVal(16.461);
      nAntiSigp[ipt]-> setVal(22.2932);
      nAntiSigm[ipt]-> setVal(1.3491e-08);
      nQCD[ipt] -> setVal(6707.2);
      nQCDp[ipt]-> setVal(3413.81);
      nQCDm[ipt]-> setVal(3383.53);
      nAntiQCD[ipt] -> setVal(5514.77);
      nAntiQCDp[ipt]-> setVal(2808.85);
      nAntiQCDm[ipt]-> setVal(2696.93);
      qcdmean[ipt] ->setVal(5.46471);
      qcdPmean[ipt]->setVal(5.54587);
      qcdMmean[ipt]->setVal(6.19874);
      qcdsigma1[ipt] ->setVal(4.42396);
      qcdPsigma1[ipt]->setVal(4.37433);
      qcdMsigma1[ipt]->setVal(5.40652);
      qcda1[ipt] ->setVal(0.221358);
      qcdPa1[ipt]->setVal(0.211348);
      qcdMa1[ipt]->setVal(0.227405);
      qcdsigma2[ipt] ->setVal(8.50868);
      qcdPsigma2[ipt]->setVal(8.73372);
      qcdMsigma2[ipt]->setVal(8.9294);
      qcda2[ipt] ->setVal(0.148137);
      qcdPa2[ipt]->setVal(0.148479);
      qcdMa2[ipt]->setVal(-0.135923);
      Frac1[ipt] ->setVal(0.678141);
      Frac1P[ipt]->setVal(0.09996);
      Frac1M[ipt]->setVal(0.330403);
      Frac2[ipt] ->setVal(0.301731);
      Frac2P[ipt]->setVal(0.825051);
      Frac2M[ipt]->setVal(0.672899);
      aqcdsigma1[ipt] ->setVal(4.38341);
      aqcdPsigma1[ipt]->setVal(4.35311);
      aqcdMsigma1[ipt]->setVal(5.11505);
      aqcdsigma2[ipt] ->setVal(9.91888);
      aqcdPsigma2[ipt]->setVal(10.0113);
      aqcdMsigma2[ipt]->setVal(6.66519);
    }else if (ipt == 5){
      nSig[ipt] -> setVal(6023.87);
      nSigp[ipt]-> setVal(3546.28);
      nSigm[ipt]-> setVal(2477.59);
      nAntiSig[ipt] -> setVal(1.01826e-07);
      nAntiSigp[ipt]-> setVal(0.000478933);
      nAntiSigm[ipt]-> setVal(1.01776e-07);
      nQCD[ipt] -> setVal(9590.38);
      nQCDp[ipt]-> setVal(4899.56);
      nQCDm[ipt]-> setVal(4690.82);
      nAntiQCD[ipt] -> setVal(6777.99);
      nAntiQCDp[ipt]-> setVal(3416.88);
      nAntiQCDm[ipt]-> setVal(3361.11);
      qcdsigma1[ipt] ->setVal(5.5129);
      qcdPsigma1[ipt]->setVal(5.5664);
      qcdMsigma1[ipt]->setVal(5.94709);
      qcda1[ipt] ->setVal(-0.271676);
      qcdPa1[ipt]->setVal(-0.271776);
      qcdMa1[ipt]->setVal(-0.271589);
      dFrac1[ipt] ->setVal(0.481629);
      dFrac1P[ipt]->setVal(0.470524);
      dFrac1M[ipt]->setVal(0.499999);
      qcdsigma2[ipt] ->setVal(7.04241);
      qcdPsigma2[ipt]->setVal(7.04276);
      qcdMsigma2[ipt]->setVal(7.1388);
      qcda2[ipt] ->setVal(0.201199);
      qcdPa2[ipt]->setVal(0.2013482);
      qcdMa2[ipt]->setVal(0.206062);
      dFrac2[ipt] ->setVal(0.479757);
      dFrac2P[ipt]->setVal(0.474536);
      dFrac2M[ipt]->setVal(0.499999);
      aqcdsigma1[ipt] ->setVal(1.25239);
      aqcdPsigma1[ipt]->setVal(1.28256);
      aqcdMsigma1[ipt]->setVal(1.18859);
      aqcdsigma2[ipt] ->setVal(6.75332);
      aqcdPsigma2[ipt]->setVal(6.75976);
      aqcdMsigma2[ipt]->setVal(6.56018);
    }else if (ipt == 6){
      nSig[ipt] -> setVal(5946.15);
      nSigp[ipt]-> setVal(3578.96);
      nSigm[ipt]-> setVal(2343.73);
      nAntiSig[ipt] -> setVal(6.79143);
      nAntiSigp[ipt]-> setVal(6.25214);
      nAntiSigm[ipt]-> setVal(8.31004e-08);
      nQCD[ipt] -> setVal(16025);
      nQCDp[ipt]-> setVal(8029.29);
      nQCDm[ipt]-> setVal(8037.15);
      nAntiQCD[ipt] -> setVal(11600.1);
      nAntiQCDp[ipt]-> setVal(6067.75);
      nAntiQCDm[ipt]-> setVal(5531.99);
      qcdsigma1[ipt] ->setVal(16.4452);
      qcdPsigma1[ipt]->setVal(10.476);
      qcdMsigma1[ipt]->setVal(9.80685);
      qcda1[ipt] ->setVal(-0.4273);
      qcdPa1[ipt]->setVal(0.114222);
      qcdMa1[ipt]->setVal(0.14445);
      dFrac1[ipt] ->setVal(0.499998);
      dFrac1P[ipt]->setVal(0.309401);
      dFrac1M[ipt]->setVal(0.499999);
      qcdsigma2[ipt] ->setVal(9.83396);
      qcdPsigma2[ipt]->setVal(15.3283);
      qcdMsigma2[ipt]->setVal(16.657);
      qcda2[ipt] ->setVal(0.131171);
      qcdPa2[ipt]->setVal(-0.334421);
      qcdMa2[ipt]->setVal(-0.463055);
      dFrac2[ipt] ->setVal(0.5);
      dFrac2P[ipt]->setVal(0.499973);
      dFrac2M[ipt]->setVal(0.499999);
      aqcdsigma1[ipt] ->setVal(16.318);
      aqcdPsigma1[ipt]->setVal(11.2372);
      aqcdMsigma1[ipt]->setVal(9.83707);
      aqcdsigma2[ipt] ->setVal(10.204);
      aqcdPsigma2[ipt]->setVal(15.3943);
      aqcdMsigma2[ipt]->setVal(16.3279);
    }else if (ipt == 7){
      nSig[ipt] -> setVal(3343.14);
      nSigp[ipt]-> setVal(1945.31);
      nSigm[ipt]-> setVal(1376.82);
      nAntiSig[ipt] -> setVal(6.05662);
      nAntiSigp[ipt]-> setVal(3.09152);
      nAntiSigm[ipt]-> setVal(2.57394);
      nQCD[ipt] -> setVal(10268.8);
      nQCDp[ipt]-> setVal(5199.41);
      nQCDm[ipt]-> setVal(5104.89);
      nAntiQCD[ipt] -> setVal(7441.34);
      nAntiQCDp[ipt]-> setVal(3862.34);
      nAntiQCDm[ipt]-> setVal(3578.59);
      qcdsigma1[ipt] ->setVal(45.7066);
      qcdPsigma1[ipt]->setVal(34.0924);
      qcdMsigma1[ipt]->setVal(31.8278);
      qcda1[ipt] ->setVal(-0.516384);
      qcdPa1[ipt]->setVal(-0.290095);
      qcdMa1[ipt]->setVal(-0.664416);
      dFrac1[ipt] ->setVal(0.0217084);
      dFrac1P[ipt]->setVal(0.0387407);
      dFrac1M[ipt]->setVal(0.5);
      qcdsigma2[ipt] ->setVal(31.1317);
      qcdPsigma2[ipt]->setVal(29.979);
      qcdMsigma2[ipt]->setVal(18.583);
      qcda2[ipt] ->setVal(-0.637742);
      qcdPa2[ipt]->setVal(-0.604042);
      qcdMa2[ipt]->setVal(-0.0586544);
      dFrac2[ipt] ->setVal(0.4495);
      dFrac2P[ipt]->setVal(0.397949);
      dFrac2M[ipt]->setVal(0.5);
      aqcdsigma1[ipt] ->setVal(43.5285);
      aqcdPsigma1[ipt]->setVal(32.2776);
      aqcdMsigma1[ipt]->setVal(30.9918);
      aqcdsigma2[ipt] ->setVal(30.6411);
      aqcdPsigma2[ipt]->setVal(29.245);
      aqcdMsigma2[ipt]->setVal(18.1504);
    }else if (ipt == 8){
      nSig[ipt] -> setVal(3150.96);
      nSigp[ipt]-> setVal(1782.18);
      nSigm[ipt]-> setVal(1400.6);
      nAntiSig[ipt] -> setVal(1.41232);
      nAntiSigp[ipt]-> setVal(6.55016);
      nAntiSigm[ipt]-> setVal(2.14356e-08);
      nQCD[ipt] -> setVal(7443.18);
      nQCDp[ipt]-> setVal(3836.04);
      nQCDm[ipt]-> setVal(3550.1);
      nAntiQCD[ipt] -> setVal(5282.92);
      nAntiQCDp[ipt]-> setVal(2746.47);
      nAntiQCDm[ipt]-> setVal(2522.99);
      qcdsigma1[ipt] ->setVal(40.0395);
      qcdPsigma1[ipt]->setVal(49.0812);
      qcdMsigma1[ipt]->setVal(43.4612);
      qcda1[ipt] ->setVal(-0.5205);
      qcdPa1[ipt]->setVal(-0.761828);
      qcdMa1[ipt]->setVal(-0.614968);
      dFrac1[ipt] ->setVal(0.323091);
      dFrac1P[ipt]->setVal(0.116719);
      dFrac1M[ipt]->setVal(0.38094);
      qcdsigma2[ipt] ->setVal(13.1481);
      qcdPsigma2[ipt]->setVal(16.8717);
      qcdMsigma2[ipt]->setVal(12.3448);
      qcda2[ipt] ->setVal(0.155389);
      qcdPa2[ipt]->setVal(0.0710501);
      qcdMa2[ipt]->setVal(0.165831);
      dFrac2[ipt] ->setVal(0.499979);
      dFrac2P[ipt]->setVal(0.499963);
      dFrac2M[ipt]->setVal(0.5);
      aqcdsigma1[ipt] ->setVal(40.0543);
      aqcdPsigma1[ipt]->setVal(51.2969);
      aqcdMsigma1[ipt]->setVal(43.108);
      aqcdsigma2[ipt] ->setVal(11.8848);
      aqcdPsigma2[ipt]->setVal(15.282);
      aqcdMsigma2[ipt]->setVal(11.4314);
    }else if (ipt == 9){
      nSig[ipt] -> setVal(2276.41);
      nSigp[ipt]-> setVal(1252.67);
      nSigm[ipt]-> setVal(1023.74);
      nAntiSig[ipt] -> setVal(6.62741e-07);
      nAntiSigp[ipt]-> setVal(2.38358e-10);
      nAntiSigm[ipt]-> setVal(1.1545e-06);
      nQCD[ipt] -> setVal(2298.66);
      nQCDp[ipt]-> setVal(1239.75);
      nQCDm[ipt]-> setVal(1058.91);
      nAntiQCD[ipt] -> setVal(1540);
      nAntiQCDp[ipt]-> setVal(805);
      nAntiQCDm[ipt]-> setVal(734.993);
      qcdsigma1[ipt] ->setVal(18.1367);
      qcdPsigma1[ipt]->setVal(16.5173);
      qcdMsigma1[ipt]->setVal(22.1053);
      qcda1[ipt] ->setVal(-0.175673);
      qcdPa1[ipt]->setVal(0.20524);
      qcdMa1[ipt]->setVal(-0.35032);
      dFrac1[ipt] ->setVal(0.5);
      dFrac1P[ipt]->setVal(0.5);
      dFrac1M[ipt]->setVal(0.5);
      qcdsigma2[ipt] ->setVal(24.1193);
      qcdPsigma2[ipt]->setVal(23.8387);
      qcdMsigma2[ipt]->setVal(25.6734);
      qcda2[ipt] ->setVal(0.00890798);
      qcdPa2[ipt]->setVal(0.008212);
      qcdMa2[ipt]->setVal(-0.0265476);
      dFrac2[ipt] ->setVal(0.5);
      dFrac2P[ipt]->setVal(0.5);
      dFrac2M[ipt]->setVal(0.499994);
      aqcdsigma1[ipt] ->setVal(17.3023);
      aqcdPsigma1[ipt]->setVal(17.50432);
      aqcdMsigma1[ipt]->setVal(20.4247);
      aqcdsigma2[ipt] ->setVal(24.6359);
      aqcdPsigma2[ipt]->setVal(17.2733);
      aqcdMsigma2[ipt]->setVal(26.9864);
    }else if (ipt == 10){
      nSig[ipt] -> setVal(549.284);
      nSigp[ipt]-> setVal(316.99);
      nSigm[ipt]-> setVal(232.294);
      nAntiSig[ipt] -> setVal(2.27872e-07);
      nAntiSigp[ipt]-> setVal(2.26654e-07);
      nAntiSigm[ipt]-> setVal(1.21661e-09);
      nQCD[ipt] -> setVal(403.477);
      nQCDp[ipt]-> setVal(171.093);
      nQCDm[ipt]-> setVal(232.384);
      nAntiQCD[ipt] -> setVal(221.9566);
      nAntiQCDp[ipt]-> setVal(131.994);
      nAntiQCDm[ipt]-> setVal(89.9626);
      qcdsigma1[ipt] ->setVal(5.69312);
      qcdPsigma1[ipt]->setVal(5.81669);
      qcdMsigma1[ipt]->setVal(22.6586);
      qcda1[ipt] ->setVal(-0.303623);
      qcdPa1[ipt]->setVal(-0.283267);
      ...
      nSig[ipt] -> setVal(180.0309);
      nSigp[ipt]-> setVal(105.057);
      nSigm[ipt]-> setVal(74.9739);
      nAntiSig[ipt] -> setVal(1.20625e-08);
      nAntiSigp[ipt]-> setVal(4.08704e-09);
      nAntiSigm[ipt]-> setVal(3.88921e-09);
      nQCD[ipt] -> setVal(72.4904);
      nQCDp[ipt]-> setVal(46.2207);
      nQCDm[ipt]-> setVal(26.2697);
      nAntiQCD[ipt] -> setVal(221.991);
      nAntiQCDp[ipt]-> setVal(131.996);
      nAntiQCDm[ipt]-> setVal(89.9953);
      qcdsigma1[ipt] ->setVal(6.08093);
      qcdPsigma1[ipt]->setVal(5.64271);
      qcdMsigma1[ipt]->setVal(6.13075);
      qcda1[ipt] ->setVal(-0.31239);
      qcdPa1[ipt]->setVal(-0.278181);
      qcdMa1[ipt]->setVal(-0.282612);
      dFrac1[ipt] ->setVal(0.5);
      dFrac1P[ipt]->setVal(0.5);
      dFrac1M[ipt]->setVal(0.499999);
      qcdsigma2[ipt] ->setVal(16.223);
      qcdPsigma2[ipt]->setVal(17.5318);
      qcdMsigma2[ipt]->setVal(14.2755);
      qcda2[ipt] ->setVal(0.160089);
      qcdPa2[ipt]->setVal(0.101803);
      qcdMa2[ipt]->setVal(0.247411);
      dFrac2[ipt] ->setVal(0.5);
      dFrac2P[ipt]->setVal(0.5);
      dFrac2M[ipt]->setVal(0.5);
      aqcdsigma1[ipt] ->setVal(5.70036);
      aqcdPsigma1[ipt]->setVal(5.6508);
      aqcdMsigma1[ipt]->setVal(5.42381);
      aqcdsigma2[ipt] ->setVal(15.0725);
      aqcdPsigma2[ipt]->setVal(17.3804);
      aqcdMsigma2[ipt]->setVal(11.0592);
    }else if (ipt == 12){
      ...
      nSig[ipt] -> setVal(45.5329);
      nSigp[ipt]-> setVal(28.3265);
      nSigm[ipt]-> setVal(17.2064);
      nAntiSig[ipt] -> setVal(6.13798e-07);
      nAntiSigp[ipt]-> setVal(5.937952e-07);
      nAntiSigm[ipt]-> setVal(2.00028e-08);
      nQCD[ipt] -> setVal(25.1377);
      nQCDp[ipt]-> setVal(14.5281);
      nQCDm[ipt]-> setVal(10.6096);
      nAntiQCD[ipt] -> setVal(221.973);
      nAntiQCDp[ipt]-> setVal(131.9888);
      nAntiQCDm[ipt]-> setVal(89.9842);
      qcdsigma1[ipt] ->setVal(27.537);
      qcdPsigma1[ipt]->setVal(34.0343);
      qcdMsigma1[ipt]->setVal(75);
      qcda1[ipt] ->setVal(-0.314215);
      qcdPa1[ipt]->setVal(-0.278132);
      qcdMa1[ipt]->setVal(-0.175101);
      dFrac1[ipt] ->setVal(0.5);
      dFrac1P[ipt]->setVal(0.5);
      dFrac1M[ipt]->setVal(0.49);
      qcdsigma2[ipt] ->setVal(36.1722);
      qcdPsigma2[ipt]->setVal(74.9995);
      qcdMsigma2[ipt]->setVal(12.452);
      qcda2[ipt] ->setVal(0.167692);
      qcdPa2[ipt]->setVal(0.128007);
      qcdMa2[ipt]->setVal(0.267127);
      dFrac2[ipt] ->setVal(0.5);
      dFrac2P[ipt]->setVal(0.5);
      dFrac2M[ipt]->setVal(0.498464);
      aqcdsigma1[ipt] ->setVal(5.70736);
      aqcdPsigma1[ipt]->setVal(5.5756);
      aqcdMsigma1[ipt]->setVal(5.1509);
      aqcdsigma2[ipt] ->setVal(14.7149);
      aqcdPsigma2[ipt]->setVal(16.1961);
      aqcdMsigma2[ipt]->setVal(18.01061);
    }
    //  
...
//W minus pt distribution
  ...
  makeHTML(outputDir);
  gBenchmark->Show("fitWEleMetModRayleighSimult_V3");
}
