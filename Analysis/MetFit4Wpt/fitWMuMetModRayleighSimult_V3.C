...
//Write All Bin Yields Information to txt file
  ...
  //for( int ipt(1);ipt<3;ipt++)
  {
    ...
    if (ipt == 0)
    {
      ...
      nSig[ipt]  -> setVal(13382.9);
      nSigp[ipt] -> setVal(7843.01);
      nSigm[ipt] -> setVal(5539.89);
      nAntiSig[ipt]  -> setVal(179.381);
      nAntiSigp[ipt] -> setVal(88.7772);
      nAntiSigm[ipt] -> setVal(90.6038);
      nQCD[ipt]  -> setVal(4400.98);
      nQCDp[ipt] -> setVal(2328.09);
      nQCDm[ipt] -> setVal(2072.89);
      nAntiQCD[ipt]  -> setVal(12041);
      nAntiQCDp[ipt] -> setVal(6119.19);
      nAntiQCDm[ipt] -> setVal(5921.81);
