...
void fitWMuMetModRayleighSimult_V3(const TString  outputDir,   // output directory
...
{
  gBenchmark->Start("fitWMuMetModRayleighSimult_V3");
...
//Write All Bin Yields Information to txt file
  ...
  for(int ipt(1);ipt<2;ipt++)
  {
    ...
    if (ipt == 0)
    {
      nSig[ipt]  -> setVal(94256.4);
      nSigp[ipt] -> setVal(56079.7);
      nSigm[ipt] -> setVal(38100);
      nAntiSig[ipt]  -> setVal(1647.7);
      nAntiSigp[ipt] -> setVal(766.074);
      nAntiSigm[ipt] -> setVal(723.568);
      nQCD[ipt]  -> setVal(24693.1);
      nQCDp[ipt] -> setVal(12594.7);
      nQCDm[ipt] -> setVal(12156.3);
      nAntiQCD[ipt]  -> setVal(66968.2);
      nAntiQCDp[ipt] -> setVal(33963.6);
      nAntiQCDm[ipt] -> setVal(33188.9);
      qcdmean[ipt] ->setVal(0.0459991);
      qcdPmean[ipt]->setVal(0.0590518);
      qcdMmean[ipt]->setVal(0.043139);
      qcda1[ipt] ->setVal(0.15174);
      qcdPa1[ipt]->setVal(0.159798);
      qcdMa1[ipt]->setVal(0.149222);
      qcdsigma1[ipt] ->setVal(11.0422);
      qcdPsigma1[ipt]->setVal(10.8741);
      qcdMsigma1[ipt]->setVal(11.0712);
      aqcdsigma1[ipt] ->setVal(11.1037);
      aqcdPsigma1[ipt]->setVal(10.8348);
      aqcdMsigma1[ipt]->setVal(11.2439);
    }else if (ipt == 1){
      nSig[ipt]  -> setVal(19361.7);
      nSigp[ipt] -> setVal(11503.3);
      nSigm[ipt] -> setVal(7858.4);
      nAntiSig[ipt]  -> setVal(150.084);
      nAntiSigp[ipt] -> setVal(83.2169);
      nAntiSigm[ipt] -> setVal(66.8671);
      nQCD[ipt]  -> setVal(429.472);
      nQCDp[ipt] -> setVal(239.837);
      nQCDm[ipt] -> setVal(189.635);
      nAntiQCD[ipt]  -> setVal(1641.17);
      nAntiQCDp[ipt] -> setVal(853.908);
      nAntiQCDm[ipt] -> setVal(787.262);
      ...
      aqcdMsigma1[ipt]->setVal(7.35891);
    }else if (ipt == 2){
...
//W minus pt distribution
  ...
  makeHTML(outputDir);
  gBenchmark->Show("fitWMuMetModRayleighSimult_V3");
}
