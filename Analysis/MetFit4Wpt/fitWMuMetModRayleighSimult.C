...
void fitWMuMetModRayleighSimult(const TString  outputDir,   // output directory
...
{
  gBenchmark->Start("fitWMuMetModRayleighSimult");
...
//W minus pt distribution
  ...
  makeHTML(outputDir);
  gBenchmark->Show("fitWMuMetModRayleighSimult");
}
