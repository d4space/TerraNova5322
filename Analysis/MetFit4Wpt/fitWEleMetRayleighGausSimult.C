...
//Write All Bin Yields Information to txt file
  ...
  //for( int ipt(12);ipt<13;ipt++)
  {
    ...
    if (ipt == 0){
      ...
      nSig[ipt] -> setVal(10395.8);
      nSigp[ipt]-> setVal(6130.56);
      nSigm[ipt]-> setVal(4265.24);
      nAntiSig[ipt] -> setVal(17.4474);
      nAntiSigp[ipt]-> setVal(10.11954);
      nAntiSigm[ipt]-> setVal(7.32786);
      nQCD[ipt] -> setVal(7171.99);
      nQCDp[ipt]-> setVal(3677.33);
      nQCDm[ipt]-> setVal(3494.66);
      nAntiQCD[ipt] -> setVal(5458.32);
      nAntiQCDp[ipt]-> setVal(2809.45);
      nAntiQCDm[ipt]-> setVal(2648.87);
      qcdmean[ipt] ->setVal(5.39573);
      qcdPmean[ipt]->setVal(5.57177);
      qcdMmean[ipt]->setVal(5.39573);
      qcdsigma1[ipt] ->setVal(4.31029);
      qcdPsigma1[ipt]->setVal(4.31279);
      qcdMsigma1[ipt]->setVal(4.31029);
      qcda1[ipt] ->setVal(0.211875);
      qcdPa1[ipt]->setVal(0.194156);
      qcdMa1[ipt]->setVal(0.211875);
      qcdsigma2[ipt] ->setVal(9.35702);
      qcdPsigma2[ipt]->setVal(9.22484);
      qcdMsigma2[ipt]->setVal(9.35702);
      qcda2[ipt] ->setVal(0.161536);
      qcdPa2[ipt]->setVal(0.170259);
      qcdMa2[ipt]->setVal(0.161536);
      Frac1[ipt] ->setVal(0.682459);
      Frac1P[ipt]->setVal(0.0384079);
      Frac1M[ipt]->setVal(0.682459);
      Frac2[ipt] ->setVal(0.304053);
      Frac2P[ipt]->setVal(0.918326);
      Frac2M[ipt]->setVal(0.304053);
    }else if (ipt == 5){
      nSig[ipt] -> setVal(5997.87);
      nSigp[ipt]-> setVal(3533.78);
      nSigm[ipt]-> setVal(2464.09);
      nAntiSig[ipt] -> setVal(0.000188328);
      nAntiSigp[ipt]-> setVal(4.50293e-08);
      nAntiSigm[ipt]-> setVal(7.32624e-08);
      nQCD[ipt] -> setVal(9692.1);
      nQCDp[ipt]-> setVal(4931.26);
      nQCDm[ipt]-> setVal(4760.84);
      nAntiQCD[ipt] -> setVal(6765);
      nAntiQCDp[ipt]-> setVal(3414);
      nAntiQCDm[ipt]-> setVal(3351);
      qcdsigma1[ipt] ->setVal(3.12592);
      qcdPsigma1[ipt]->setVal(2.80913);
      qcdMsigma1[ipt]->setVal(3.57984);
      qcda1[ipt] ->setVal(0.191154);
      qcdPa1[ipt]->setVal(0.211806);
      qcdMa1[ipt]->setVal(0.142866);
      dFrac1[ipt] ->setVal(0.499988);
      dFrac1P[ipt]->setVal(0.499948);
      dFrac1M[ipt]->setVal(0.499992);
      qcdsigma2[ipt] ->setVal(7.31878);
      qcdPsigma2[ipt]->setVal(7.15494);
      qcdMsigma2[ipt]->setVal(7.61713);
      qcda2[ipt] ->setVal(0.194762);
      qcdPa2[ipt]->setVal(0.198547);
      qcdMa2[ipt]->setVal(0.184409);
      dFrac2[ipt] ->setVal(0.499997);
      dFrac2P[ipt]->setVal(0.5);
      dFrac2M[ipt]->setVal(0.499992);
    }else if (ipt == 6){
      nSig[ipt] -> setVal(5806.53);
      nSigp[ipt]-> setVal(3461.54);
      nSigm[ipt]-> setVal(2344.99);
      nAntiSig[ipt] -> setVal(8.72909);
      nAntiSigp[ipt]-> setVal(3.32766);
      nAntiSigm[ipt]-> setVal(5.40143);
      nQCD[ipt] -> setVal(16225.2);
      nQCDp[ipt]-> setVal(8196.72);
      nQCDm[ipt]-> setVal(8028.48);
      nAntiQCD[ipt] -> setVal(11487);
      nAntiQCDp[ipt]-> setVal(6011.84);
      nAntiQCDm[ipt]-> setVal(5475.16);
      qcdsigma1[ipt] ->setVal(16.5463);
      qcdPsigma1[ipt]->setVal(10.7855);
      qcdMsigma1[ipt]->setVal(9.83441);
      qcda1[ipt] ->setVal(-0.431917);
      qcdPa1[ipt]->setVal(0.123456);
      qcdMa1[ipt]->setVal(0.145972);
      dFrac1[ipt] ->setVal(0.5);
      dFrac1P[ipt]->setVal(0.295596);
      dFrac1M[ipt]->setVal(0.496533);
      qcdsigma2[ipt] ->setVal(9.91348);
      qcdPsigma2[ipt]->setVal(15.1687);
      qcdMsigma2[ipt]->setVal(16.6025);
      qcda2[ipt] ->setVal(0.137391);
      qcdPa2[ipt]->setVal(-0.317494);
      qcdMa2[ipt]->setVal(-0.462609);
      dFrac2[ipt] ->setVal(0.5);
      dFrac2P[ipt]->setVal(0.495749);
      dFrac2M[ipt]->setVal(0.48985);
    }else if (ipt == 7){
      ...
      nSig[ipt] -> setVal(557.42);
      nSigp[ipt]-> setVal(307.798);
      nSigm[ipt]-> setVal(240.454);
      nAntiSig[ipt] -> setVal(5.56729e-07);
      nAntiSigp[ipt]-> setVal(1.4913e-08);
      nAntiSigm[ipt]-> setVal(5.26638e-07);
      nQCD[ipt] -> setVal(385.727);
      nQCDp[ipt]-> setVal(178.089);
      nQCDm[ipt]-> setVal(219.498);
      nAntiQCD[ipt] -> setVal(211.999);
      nAntiQCDp[ipt]-> setVal(125.995);
      nAntiQCDm[ipt]-> setVal(85.9999);
      qcdsigma1[ipt] ->setVal(5.66708);
      qcdPsigma1[ipt]->setVal(5.76427);
      qcdMsigma1[ipt]->setVal(21.2459);
      qcda1[ipt] ->setVal(-0.305142);
      qcdPa1[ipt]->setVal(-0.283703);
      qcdMa1[ipt]->setVal(-0.315718);
      dFrac1[ipt] ->setVal(0.5);
      dFrac1P[ipt]->setVal(0.5);
      dFrac1M[ipt]->setVal(0.43282);
      qcdsigma2[ipt] ->setVal(14.7367);
      qcdPsigma2[ipt]->setVal(15.9874);
      qcdMsigma2[ipt]->setVal(14.3623);
      qcda2[ipt] ->setVal(0.169381);
      qcdPa2[ipt]->setVal(0.134046);
      qcdMa2[ipt]->setVal(0.231529);
      dFrac2[ipt] ->setVal(0.5);
      dFrac2P[ipt]->setVal(0.5);
      dFrac2M[ipt]->setVal(0.491558);
    }else if (ipt == 11){
      nSig[ipt] -> setVal(182.743);
      nSigp[ipt]-> setVal(104.842);
      nSigm[ipt]-> setVal(77.901);
      nAntiSig[ipt] -> setVal(0.000300383);
      nAntiSigp[ipt]-> setVal(0.00197555);
      nAntiSigm[ipt]-> setVal(0.0001971);
      nQCD[ipt] -> setVal(69.779);
      nQCDp[ipt]-> setVal(46.7489);
      nQCDm[ipt]-> setVal(23.0301);
      nAntiQCD[ipt] -> setVal(222.808);
      nAntiQCDp[ipt]-> setVal(131.267);
      nAntiQCDm[ipt]-> setVal(91.541);
      qcdsigma1[ipt] ->setVal(5.81369);
      qcdPsigma1[ipt]->setVal(5.71042);
      qcdMsigma1[ipt]->setVal(5.48101);
      qcda1[ipt] ->setVal(-0.109919);
      qcdPa1[ipt]->setVal(-0.278798);
      qcdMa1[ipt]->setVal(-0.183359);
      dFrac1[ipt] ->setVal(0.5);
      dFrac1P[ipt]->setVal(0.5);
      dFrac1M[ipt]->setVal(0.5);
      qcdsigma2[ipt] ->setVal(16.79);
      qcdPsigma2[ipt]->setVal(16.8987);
      qcdMsigma2[ipt]->setVal(10.7648);
      qcda2[ipt] ->setVal(0.114172);
      qcdPa2[ipt]->setVal(0.116683);
      qcdMa2[ipt]->setVal(0.248519);
      dFrac2[ipt] ->setVal(0.5);
      dFrac2P[ipt]->setVal(0.5);
      dFrac2M[ipt]->setVal(0.5);
    }else if (ipt == 12){
      nSig[ipt] -> setVal(91.9312);
      nSigp[ipt]-> setVal(55.3774);
      nSigm[ipt]-> setVal(36.4158);
      nAntiSig[ipt] -> setVal(6.36069e-07);
      nAntiSigp[ipt]-> setVal(0.00314901);
      nAntiSigm[ipt]-> setVal(2.95447e-07);
      nQCD[ipt] -> setVal(22.2265);
      nQCDp[ipt]-> setVal(6.32157);
      nQCDm[ipt]-> setVal(16.3333);
      nAntiQCD[ipt] -> setVal(211.794);
      nAntiQCDp[ipt]-> setVal(131.296);
      nAntiQCDm[ipt]-> setVal(90.3866);
      qcdsigma1[ipt] ->setVal(3.14769);
      qcdPsigma1[ipt]->setVal(5.99326);
      qcdMsigma1[ipt]->setVal(5.37902);
      qcda1[ipt] ->setVal(0.281856);
      qcdPa1[ipt]->setVal(0.279049);
      ...
      qcdMsigma2[ipt]->setVal(10.6185);
      qcda2[ipt] ->setVal(0.159594);
      qcdPa2[ipt]->setVal(0.148015);
      qcdMa2[ipt]->setVal(0.24915);
      dFrac2[ipt] ->setVal(0.499865);
      dFrac2P[ipt]->setVal(0.46938);
      dFrac2M[ipt]->setVal(0.499995);
    }else if (ipt == 13){
      nSig[ipt] -> setVal(56.4496);
      nSigp[ipt]-> setVal(33.2185);
      nSigm[ipt]-> setVal(23.2311);
      nAntiSig[ipt] -> setVal(0.000476437);
      nAntiSigp[ipt]-> setVal(1.43406e-06);
      nAntiSigm[ipt]-> setVal(0.000462096);
      nQCD[ipt] -> setVal(12.5856);
      nQCDp[ipt]-> setVal(7.16415);
      nQCDm[ipt]-> setVal(5.42145);
      nAntiQCD[ipt] -> setVal(222.374);
      nAntiQCDp[ipt]-> setVal(131.319);
      nAntiQCDm[ipt]-> setVal(91.055);
      qcdsigma1[ipt] ->setVal(5.6952);
      qcdPsigma1[ipt]->setVal(5.71618);
      qcdMsigma1[ipt]->setVal(5.39096);
      qcda1[ipt] ->setVal(-0.223031);
      qcdPa1[ipt]->setVal(-0.279162);
      qcdMa1[ipt]->setVal(-0.280748);
      dFrac1[ipt] ->setVal(0.5);
      dFrac1P[ipt]->setVal(0.5);
      dFrac1M[ipt]->setVal(0.5);
      qcdsigma2[ipt] ->setVal(16.4505);
      qcdPsigma2[ipt]->setVal(16.3495);
      qcdMsigma2[ipt]->setVal(11.0381);
      qcda2[ipt] ->setVal(-0.0143761);
      qcdPa2[ipt]->setVal(0.128218);
      qcdMa2[ipt]->setVal(0.24851);
      dFrac2[ipt] ->setVal(0.499999);
      dFrac2P[ipt]->setVal(0.5);
      dFrac2M[ipt]->setVal(0.5);
    }
    ...
    if (ipt<4){
      ...
      InValfile<<"qcdMsigma2[ipt]->setVal("<<qcd1m[ipt]->s2->getValV()<<"+gRandom->Gaus(0,1)*"<<qcd1m[ipt]->s2->getError()<<");"<<endl;
