...
void fitWMuMetMtModRayleighSimult_nEWKfixed(const TString  outputDir,   // output directory
...
{
  gBenchmark->Start("fitWMuMetMtModRayleighSimult_nEWKfixed");
...
//W minus pt distribution
  ...
  gBenchmark->Show("fitWMuMetMtModRayleighSimult_nEWKfixed");
}
