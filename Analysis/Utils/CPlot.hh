...
public:
  ...
  TString sOutDirDummy;  // output directory
  void setOutDir(TString haha){sOutDirDummy = haha;};  // output directory
...
//  void Clear(){}
  ...
  void AddHist1D(TH1D *h, TString drawopt="", int color=kBlack, int linesty=1, int fillsty=0, int mkerSty=20, int mkerSize=1);    
