...
public:
  ...
  RecoilCorrector(){};//default constructor
  ~RecoilCorrector();
...
void RecoilCorrector::Correct(Double_t &pfmet, Double_t &pfmetphi,
  ...
  double pfu1meanZdata  = pfu1mean;
  double pfu1sigma1Zdata= pfu1sigma1;
  double pfu1sigma2Zdata= pfu1sigma2;
  double pfu2meanZdata  = pfu2mean;
  double pfu2sigma1Zdata= pfu2sigma1;
  double pfu2sigma2Zdata= pfu2sigma2;
  double pfu1frac2Wp=(fcnPFu1sigma0_Wp->Eval(genWPt)-fcnPFu1sigma1_Wp->Eval(genWPt))/(fcnPFu1sigma2_Wp->Eval(genWPt)-fcnPFu1sigma1_Wp->Eval(genWPt));
  double pfu2frac2Wp=(fcnPFu2sigma0_Wp->Eval(genWPt)-fcnPFu2sigma1_Wp->Eval(genWPt))/(fcnPFu2sigma2_Wp->Eval(genWPt)-fcnPFu2sigma1_Wp->Eval(genWPt));
  ...
  //cout<<"genWpt: "<<genWPt<<"--------------------------------------"<<endl;
  //cout<<"z1:z2 "<<z1<<":"<<z2<<endl;
  //cout<<"          ZmmData      ZMC         Wp        New    scale+smeared(mean+sigma)"<<endl;
  //cout<<"u1mean:  "<<pfu1meanZdata<<"   "  <<fcnPFu1mean_Z->Eval(genWPt)<<"   "  <<fcnPFu1mean_Wp->Eval(genWPt)<<"  "  <<pfu1mean<<"  "<<pfu1<<endl;
  //cout<<"u1sigma1 "<<pfu1sigma1Zdata<<"   "<<fcnPFu1sigma1_Z->Eval(genWPt)<<"   "<<fcnPFu1sigma1_Wp->Eval(genWPt)<<"  "<<pfu1sigma1<<endl;
  //cout<<"u1sigma2 "<<pfu1sigma2Zdata<<"   "<<fcnPFu1sigma2_Z->Eval(genWPt)<<"   "<<fcnPFu1sigma2_Wp->Eval(genWPt)<<"  "<<pfu1sigma2<<endl;
  //cout<<"u1Frac2  " <<"                                   "<<pfu1frac2Wp<<"  "<<pfu1frac2<<endl;
  //cout<<"u2mean:  "<<pfu2meanZdata<<"   "  <<fcnPFu2mean_Z->Eval(genWPt)<<"   "  <<fcnPFu2mean_Wp->Eval(genWPt)<<"  "  <<pfu2mean<<"  "<<pfu2<<endl;
  //cout<<"u2sigma1 "<<pfu2sigma1Zdata<<"   "<<fcnPFu2sigma1_Z->Eval(genWPt)<<"   "<<fcnPFu2sigma1_Wp->Eval(genWPt)<<"  "<<pfu2sigma1<<endl;
  //cout<<"u2sigma2 "<<pfu2sigma2Zdata<<"   "<<fcnPFu2sigma2_Z->Eval(genWPt)<<"   "<<fcnPFu2sigma2_Wp->Eval(genWPt)<<"  "<<pfu2sigma2<<endl;
  //cout<<"u2Frac2  " <<"                                   "<<pfu2frac2Wp<<"  "<<pfu2frac2<<endl;
}
