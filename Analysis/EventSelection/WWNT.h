...
// Tue Mar 25 01:46:38 2014 by ROOT version 5.34/14
// from TChain WW/tree/
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      f->GetObject("WW/tree",tree);

#else // SINGLE_TREE

      // The following code should be used if you want this class to access a chain
      // of trees.
      TChain * chain = new TChain("WW/tree","");
      chain->Add("/terranova_1/TestNtuple/TerraTuple.root/WW/tree");
      tree = chain;
#endif // SINGLE_TREE
...
Int_t WWNT::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t WWNT::LoadTree(Long64_t entry)
{
