...
int WZ3LBase::InitVar()
{
  cout<<"Initialize variables at WZ3LBase Class ==================="<<endl;
...
int WZ3LBase::DumpWbestCand(int i)
{
  W.charge = (*W_Charge)[i];
  //Muon Variable Study----------------------
