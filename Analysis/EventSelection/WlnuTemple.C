...
{
  cout<<"Initialize variable at WlnuTemple class ==========="<<endl;
  evtCnt = 0;
  mNWevt = 0;
  for(int i(0);i<NwPtBin;i++)
  {
...
double WlnuTemple::CalcEvtWeight()
{
...
int WlnuTemple::WlnuTemple::Fill_METs()
{
...
int WlnuTemple::Fill_METprofiles()
{
