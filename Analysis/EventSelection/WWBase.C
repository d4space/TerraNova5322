...
int WWBase::InitVar()
{
  cout<<"Initialize variables at WWBase Class ==================="<<endl;
...
int WWBase::DumpWbestCand(int i)
{
  W.charge = (*W_Charge)[i];
  //Muon Variable Study----------------------
