...
// Wed Jun 11 19:13:46 2014 by ROOT version 5.32/00
// from TChain Susy/tree/
//////////////////////////////////////////////////////////
...
#ifdef mSUGRANT_cxx
mSUGRANT::mSUGRANT(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      f->GetObject("Susy/tree",tree);

#else // SINGLE_TREE

      // The following code should be used if you want this class to access a chain
      // of trees.
      TChain * chain = new TChain("Susy/tree","");
      chain->Add("../MVAnoPUMETana/aa.root/Susy/tree");
      tree = chain;
#endif // SINGLE_TREE
...
Int_t mSUGRANT::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t mSUGRANT::LoadTree(Long64_t entry)
{
...
void mSUGRANT::Show(Long64_t entry)
{
...
Int_t mSUGRANT::Cut(Long64_t entry)
{
