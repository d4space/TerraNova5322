...
// Tue Mar 11 20:56:12 2014 by ROOT version 5.34/14
// from TChain MonoJet/tree/
//////////////////////////////////////////////////////////
...
#ifdef MonoJetNT_cxx
MonoJetNT::MonoJetNT(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      f->GetObject("MonoJet/tree",tree);

#else // SINGLE_TREE

      // The following code should be used if you want this class to access a chain
      // of trees.
      TChain * chain = new TChain("MonoJet/tree","");
      chain->Add("/terranova_1/TestNtuple/TerraTuple.root/MonoJet/tree");
      tree = chain;
#endif // SINGLE_TREE
...
Int_t MonoJetNT::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MonoJetNT::LoadTree(Long64_t entry)
{
...
void MonoJetNT::Init(TTree *tree)
{
...
void MonoJetNT::Show(Long64_t entry)
{
...
Int_t MonoJetNT::Cut(Long64_t entry)
{
