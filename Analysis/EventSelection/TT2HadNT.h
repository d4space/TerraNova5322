...
// Tue Mar 11 16:06:39 2014 by ROOT version 5.34/14
// from TChain TT2Hadron/tree/
//////////////////////////////////////////////////////////
...
#ifdef TT2HadNT_cxx
TT2HadNT::TT2HadNT(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      f->GetObject("TT2Hadron/tree",tree);

#else // SINGLE_TREE

      // The following code should be used if you want this class to access a chain
      // of trees.
      TChain * chain = new TChain("TT2Hadron/tree","");
      chain->Add("/terranova_1/TestNtuple/TerraTuple.root/TT2Hadron/tree");
      tree = chain;
#endif // SINGLE_TREE
...
Int_t TT2HadNT::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TT2HadNT::LoadTree(Long64_t entry)
{
...
void TT2HadNT::Show(Long64_t entry)
{
...
Int_t TT2HadNT::Cut(Long64_t entry)
{
