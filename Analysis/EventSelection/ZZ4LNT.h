...
// Tue Mar 18 02:21:15 2014 by ROOT version 5.34/14
// from TChain ZZ4L/tree/
//////////////////////////////////////////////////////////
...
#ifdef ZZ4LNT_cxx
ZZ4LNT::ZZ4LNT(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      f->GetObject("ZZ4L/tree",tree);

#else // SINGLE_TREE

      // The following code should be used if you want this class to access a chain
      // of trees.
      TChain * chain = new TChain("ZZ4L/tree","");
      chain->Add("/terranova_1/TestNtuple/TerraTuple.root/ZZ4L/tree");
      tree = chain;
#endif // SINGLE_TREE
...
Int_t ZZ4LNT::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ZZ4LNT::LoadTree(Long64_t entry)
{
...
void ZZ4LNT::Show(Long64_t entry)
{
...
Int_t ZZ4LNT::Cut(Long64_t entry)
{
