...
int biasStudy(const TString BaseName)
{
  ...
  fToy = new TFile("../BiasStudyToy/Result"+BaseName+"/Result_"+BaseName+".root");
  ...
  dGen = (TH1D*)fToy->Get("hGenDetNorm")->Clone();
  ...
  lC0->SaveAs(BaseName+"_dUnfGenLvl.png");
  return 0;
}
