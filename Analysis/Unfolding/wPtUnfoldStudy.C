...
//Absolute Normalized correlated error matrix 
 ...
 // }
  ...
  if(BaseName == "WpToMuNu"){
    TotalUncertErr[0] = 0;
    TotalUncertErr[1] = 3.35 ; 
    TotalUncertErr[2] = 3.51 ; 
    TotalUncertErr[3] = 3.35 ; 
    TotalUncertErr[4] = 4.73 ; 
    TotalUncertErr[5] = 4.46 ; 
    TotalUncertErr[6] = 4.99 ; 
    TotalUncertErr[7] = 4.98 ; 
    TotalUncertErr[8] = 6.89 ; 
    TotalUncertErr[9] = 6.71 ; 
    TotalUncertErr[10]= 6.52 ; 
    TotalUncertErr[11]= 11.27; 
    TotalUncertErr[12]= 19.22; 
    TotalUncertErr[13]= 25.23; 
    errPowheg[0] = 0; 
    errPowheg[1] = 4.268; 
    errPowheg[2] = 4.147; 
    errPowheg[3] = 4.122; 
    ...
    TotalUncertErr[0] = 0;
    TotalUncertErr[1] = 3.28 ;
    TotalUncertErr[2] = 3.39 ;
    TotalUncertErr[3] = 3.38 ;
    TotalUncertErr[4] = 3.96 ;
    TotalUncertErr[5] = 4.30 ;
    TotalUncertErr[6] = 5.27 ;
    TotalUncertErr[7] = 5.11 ;
    TotalUncertErr[8] = 6.14 ;
    TotalUncertErr[9] = 5.71 ;
    TotalUncertErr[10]= 7.28 ;
    TotalUncertErr[11]= 12.88;
    TotalUncertErr[12]= 17.61;
    TotalUncertErr[13]= 34.21;
    errPowheg[0] = 0; 
    errPowheg[1] = 4.4  ; 
    errPowheg[2] = 4.385; 
    errPowheg[3] = 4.426; 
    ...
    TotalUncertErr[4] = 3.91 ; 
    TotalUncertErr[5] = 4.27 ; 
    TotalUncertErr[6] = 4.80 ; 
    TotalUncertErr[7] = 5.62 ; 
    TotalUncertErr[8] = 7.19 ; 
    TotalUncertErr[9] = 7.84 ; 
    TotalUncertErr[10]= 9.12 ; 
    TotalUncertErr[11]= 13.54; 
    TotalUncertErr[12]= 19.29; 
    TotalUncertErr[13]= 26.84;
    errPowheg[0] = 0; 
    errPowheg[1] = 4.369; 
    errPowheg[2] = 4.373; 
    errPowheg[3] = 4.392; 
