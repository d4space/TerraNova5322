...
//Absolute Normalized correlated error matrix 
 ...
 // }
  ...
  if(BaseName == "WpToMuNu"){
    ...
    TotalUncertErr[2] = 3.30 ; 
    TotalUncertErr[3] = 3.33 ; 
    TotalUncertErr[4] = 4.70 ; 
    TotalUncertErr[5] = 4.33 ; 
    TotalUncertErr[6] = 4.99 ; 
    TotalUncertErr[7] = 5.02 ; 
    TotalUncertErr[8] = 6.83 ; 
    TotalUncertErr[9] = 6.94 ; 
    TotalUncertErr[10]= 6.48 ; 
    TotalUncertErr[11]= 10.16; 
    TotalUncertErr[12]= 16.55; 
    TotalUncertErr[13]= 21.73; 
    errPowheg[0] = 0; 
    errPowheg[1] = 4.268; 
    errPowheg[2] = 4.147; 
    errPowheg[3] = 4.122; 
    ...
    TotalUncertErr[0] = 0; 
    TotalUncertErr[1] = 3.36 ;
    TotalUncertErr[2] = 3.36 ;
    TotalUncertErr[3] = 3.44 ;
    TotalUncertErr[4] = 4.14 ;
    TotalUncertErr[5] = 4.30 ;
    TotalUncertErr[6] = 5.17 ;
    TotalUncertErr[7] = 5.10 ;
    TotalUncertErr[8] = 6.35 ;
    TotalUncertErr[9] = 7.24 ;
    TotalUncertErr[10]= 10.08;
    TotalUncertErr[11]= 15.42;
    TotalUncertErr[12]= 20.27;
    TotalUncertErr[13]= 34.99;
    errPowheg[0] = 0; 
    errPowheg[1] = 4.398; 
    errPowheg[2] = 4.382; 
    errPowheg[3] = 4.423; 
    ...
    TotalUncertErr[2] = 3.53 ; 
    TotalUncertErr[3] = 3.35 ; 
    TotalUncertErr[4] = 3.75 ; 
    TotalUncertErr[5] = 4.22 ; 
    TotalUncertErr[6] = 4.92 ; 
    TotalUncertErr[7] = 5.65 ; 
    TotalUncertErr[8] = 7.48 ; 
    TotalUncertErr[9] = 7.49 ; 
    TotalUncertErr[10]= 8.35 ; 
    TotalUncertErr[11]= 11.40; 
    TotalUncertErr[12]= 15.06; 
    TotalUncertErr[13]= 25.18;
    errPowheg[0] = 0; 
    errPowheg[1] = 4.37 ; 
    errPowheg[2] = 4.314; 
    errPowheg[3] = 4.109; 
    ...
    TotalUncertErr[0] = 0; 
    TotalUncertErr[1] = 4.13 ; 
    TotalUncertErr[2] = 3.59 ; 
    TotalUncertErr[3] = 3.48 ; 
    TotalUncertErr[4] = 3.86 ; 
    TotalUncertErr[5] = 4.29 ; 
    TotalUncertErr[6] = 4.95 ; 
    TotalUncertErr[7] = 5.85 ; 
    TotalUncertErr[8] = 7.49 ; 
    TotalUncertErr[9] = 8.14 ; 
    TotalUncertErr[10]= 9.33 ; 
    TotalUncertErr[11]= 13.28; 
    TotalUncertErr[12]= 18.77; 
    TotalUncertErr[13]= 26.63;
    errPowheg[0] = 0; 
    errPowheg[1] = 4.285; 
    errPowheg[2] = 4.156; 
    errPowheg[3] = 4.132; 
