...
//  TH1F *lHDiff  = new TH1F((lName+"Diff").c_str(),(lName+"Diff").c_str(),nptBins,xbins_pt); lHDiff->Sumw2();
  ...
  //lHDiff->GetYaxis()->SetRangeUser(0.7,1.2);
  lHDiff->GetYaxis()->SetRangeUser(0.4,1.3);
...
//  lCTree->Draw(lCDraw.str().c_str(),iCCut.c_str());
  ...
  Double_t derr[14] = {0,
    3.00323159280132757e+00, 
    2.95705935009766074e+00,
    3.05617407881161096e+00,
    3.17288512240831055e+00,
    3.63628931742236361e+00,
    3.45615393175709107e+00,
    4.57017505135197233e+00,
    5.03698322411341781e+00,
    5.57790283171013979e+00,
    9.75037435178773038e+00,
    1.72359653051402937e+01,
    2.15247020885307485e+01,
    2.12190951739229448e+01
  };
...
*/  
  ...
  powheg->GetYaxis()->SetRangeUser(0.,1200);
  powheg->SetTitle("");
