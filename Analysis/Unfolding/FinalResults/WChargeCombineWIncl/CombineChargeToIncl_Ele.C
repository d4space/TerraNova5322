...
//  Print out result
  ...
  for(int i(1);i<14;i++)
  {
    ...
    for(int i(1);i<14;i++)
    {
      ...
      //SVD_BornGen->SetBinError(i,sqrt(h_MC_p->GetBinContent(i) + h_MC_m->GetBinContent(i)+h_MC_p->GetBinError(i)*h_MC_p->GetBinError(i) + h_MC_m->GetBinError(i)*h_MC_m->GetBinError(i)));
