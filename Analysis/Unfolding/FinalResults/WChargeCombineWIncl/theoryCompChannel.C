...
int theoryCompChannel(const TString BaseName)
{
  ...
  }else if (BaseName=="WInclusive"){
    //f_Resbos_Mu  = new TFile("../../../RstResbos/Resbos_WInclToMuNu.root");
    //f_Resbos_Ele = new TFile("../../../RstResbos/Resbos_WInclToEleNu.root");
    f_Resbos_Mu  = new TFile("ResultWInclToMuNu/Result_WInclToMuNu_Theory.root");
    f_Resbos_Ele = new TFile("ResultWInclToEleNu/Result_WInclToEleNu_Theory.root");
    f_Data_Mu    = new TFile("ResultWInclToMuNu/Result_WInclToMuNu.root");
    f_Data_Ele   = new TFile("ResultWInclToEleNu/Result_WInclToEleNu.root");
  }
...
//Find Error  
 ...
 // lL->AddEntry(hFewz,"FEWZ CTEQ12 NNLO","f");
  ...
  if(BaseName=="WInclusive")
    sprintf(tmpName,"dataOvResIncl.png");
  lC0->SaveAs(tmpName);
  return 0;
}
