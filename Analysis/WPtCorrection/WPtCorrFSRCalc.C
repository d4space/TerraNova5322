...
int WPtCorrFSRCalc(const TString BaseName)
{
  TString resultDir = "ResultsFSRFactor";
  ...
  //fWpMN_MCNom = new TFile("../Unfolding/ResultWpToMuNu/Result_WpToMuNu.root");
  //fWmMN_MCNom = new TFile("../Unfolding/ResultWmToMuNu/Result_WmToMuNu.root");
  //fWpEN_MCNom = new TFile("../Unfolding/ResultWpToEleNu/Result_WpToEleNu.root");
  //fWmEN_MCNom = new TFile("../Unfolding/ResultWmToEleNu/Result_WmToEleNu.root");
  fWpMN_MCNom = new TFile("../WPtAcceptance/Muon2012LoPU/WpToMuNu_S8.root");
  fWmMN_MCNom = new TFile("../WPtAcceptance/Muon2012LoPU/WmToMuNu_S8.root");
  fWpEN_MCNom = new TFile("../WPtAcceptance/Electron2012LoPU/WpToEleNu_S8.root");
  fWmEN_MCNom = new TFile("../WPtAcceptance/Electron2012LoPU/WmToEleNu_S8.root");
...
cout << "check1" << endl;
  ...
  // Histo from root
  //======================
  h1_WpT_WpToMN_MCNom = (TH1D*)fWpMN_MCNom->Get("h1_Born_BothFid")->Clone("h1_WpT_WpToMN_MCNom");
  h1_WpT_WpToMN_MCNom_Log = new TH1D("h1_WpT_WpToMN_MCNom_Log","h1_WpT_WpToMN_MCNom_Log",13,WptLogBins);
  
  h1_WpT_WmToMN_MCNom = (TH1D*)fWmMN_MCNom->Get("h1_Born_BothFid")->Clone("h1_WpT_WmToMN_MCNom");
  h1_WpT_WmToMN_MCNom_Log = new TH1D("h1_WpT_WmToMN_MCNom_Log","h1_WpT_WmToMN_MCNom_Log",13,WptLogBins);
  
  h1_WpT_WpToEN_MCNom = (TH1D*)fWpEN_MCNom->Get("h1_Born_BothFid")->Clone("h1_WpT_WpToEN_MCNom");
  h1_WpT_WpToEN_MCNom_Log = new TH1D("h1_WpT_WpToEN_MCNom_Log","h1_WpT_WpToEN_MCNom_Log",13,WptLogBins);
  
  h1_WpT_WmToEN_MCNom = (TH1D*)fWmEN_MCNom->Get("h1_Born_BothFid")->Clone("h1_WpT_WmToEN_MCNom");
  ...
  for(int i(1);i<=13;i++)
  {
    cout<<"Bin "<<i<<" : " <<"Mu+:  "<< h1_WpT_WpToMN_MCNom->GetBinContent(i) <<"\t"<<"Mu-:  "<<h1_WpT_WmToMN_MCNom->GetBinContent(i)<< endl;
  } 


  h1_WpT_WpToMN_RDNom = (TH1D*)fWpMN_RDNom->Get("FSRUnf")->Clone("h1_WpT_WpToMN_RDNom");
  h1_WpT_WmToMN_RDNom=  (TH1D*)fWmMN_RDNom->Get("FSRUnf")->Clone("h1_WpT_WmToMN_RDNom");
  h1_WpT_WpToEN_RDNom = (TH1D*)fWpEN_RDNom->Get("FSRUnf")->Clone("h1_WpT_WpToEN_RDNom");
  h1_WpT_WmToEN_RDNom = (TH1D*)fWmEN_RDNom->Get("FSRUnf")->Clone("h1_WpT_WmToEN_RDNom");
  ...
  pltWpMN->GetLegend()->AddEntry(h1_WpT_WpToMN_MCNom_Log,"Nominal BornBothFid","l");
  pltWmMN->GetLegend()->AddEntry(h1_WpT_WmToMN_MCNom_Log,"Nominal BornBothFid","l");
  pltWpMN->GetLegend()->AddEntry(h1_WpT_WpToMN_RDNom,"Nominal FSR Unfolded Data ","p");
  pltWmMN->GetLegend()->AddEntry(h1_WpT_WmToMN_RDNom,"Nominal FSR Unfolded Data ","p");

  pltWpEN->GetLegend()->AddEntry(h1_WpT_WpToEN_MCNom_Log,"Nominal BornBothFid","l");
  pltWmEN->GetLegend()->AddEntry(h1_WpT_WmToEN_MCNom_Log,"Nominal BornBothFid","l");
  pltWpEN->GetLegend()->AddEntry(h1_WpT_WpToEN_RDNom,"Nominal FSR Unfolded Data","p");
  pltWmEN->GetLegend()->AddEntry(h1_WpT_WmToEN_RDNom,"Nominal FSR Unfolded Data","p");
  ...
  pltWpMN_ratio->GetLegend()->AddEntry(h1_WpT_WpToMN_ratio,"WpToMN FSR Unfolded Data/MC BornBothFid");
  pltWmMN_ratio->GetLegend()->AddEntry(h1_WpT_WmToMN_ratio,"WmToMN FSR Unfolded Data/MC BornBothFid");
  pltWpEN_ratio->GetLegend()->AddEntry(h1_WpT_WpToEN_ratio,"WpToEN FSR Unfolded Data/MC BornBothFid");
  pltWmEN_ratio->GetLegend()->AddEntry(h1_WpT_WmToEN_ratio,"WmToEN FSR Unfolded Data/MC BornBothFid");
  ...
  TFile *RootOut= new TFile("../RstSelection/WpT_FSRData_MC_ratio.root","recreate");
