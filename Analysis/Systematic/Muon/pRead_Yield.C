...
int pRead_Yield(TString CorrName) { 
  ...
  for(int i(1);i<=NumOfSamples;i++) {
    ...
    {
      sprintf(tmpName,"../EventSelection%d/ResultWpToMuNu/Result_WpToMuNu.root",i);
    }
  ...
  double cl1  = 11802.4244*(1.-0.03); 
  double cl2  = 11762.0139*(1.-0.03);
  double cl3  = 9307.3034 *(1.-0.03);
  double cl4  = 7879.2348 *(1.-0.03);
  double cl5  = 4537.4760 *(1.-0.03);
  double cl6  = 4442.0717 *(1.-0.03);
  double cl7  = 2266.3845 *(1.-0.03);
  double cl8  = 2357.0375 *(1.-0.03);
  double cl9  = 1542.9109 *(1.-0.03);
  double cl10 = 368.8788  *(1.-0.03); 
  double cl11 = 119.7725  *(1.-0.03); 
  double cl12 = 43.0586   *(1.-0.03); 
  double cl13 = 24.4841   *(1.-0.03); 
                          
  double ch1  = 11802.4244*(1.+0.03);
  double ch2  = 11762.0139*(1.+0.03);
  double ch3  = 9307.3034 *(1.+0.03);
  double ch4  = 7879.2348 *(1.+0.03);
  double ch5  = 4537.4760 *(1.+0.03);
  double ch6  = 4442.0717 *(1.+0.03);
  double ch7  = 2266.3845 *(1.+0.03);
  double ch8  = 2357.0375 *(1.+0.03);
  double ch9  = 1542.9109 *(1.+0.03);
  double ch10 = 368.8788  *(1.+0.03);
  double ch11 = 119.7725  *(1.+0.03);
  double ch12 = 43.0586   *(1.+0.03);
  double ch13 = 24.4841   *(1.+0.03);
