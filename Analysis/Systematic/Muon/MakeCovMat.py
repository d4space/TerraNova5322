...
if CorrName=="EffCorr" or CorrName=="ScaleCorr" or CorrName=="SmearCorr" or CorrName=="RecoilCorr":
  DataFile="/d2/scratch/khakim/WAnalysis/InclWZ_FinalEffSF/KoSMP/WAnalyzer/analysis/RstSelection/SigYields_Muon_Nominal.root"
  DataYieldFile="pRecon.root"
#Unf.Stage
if CorrName=="dUnf" or CorrName=="PostEffCorr" or CorrName=="FSRUnf" or CorrName=="BornEffCorr":
  DataFile="/d2/scratch/khakim/WAnalysis/InclWZ_FinalEffSF/KoSMP/WAnalyzer/analysis/Unfolding/ResultWpToMuNu/Result_WpToMuNu.root"
...
#Unf.Stage
if CorrName=="dUnf" or CorrName=="PostEffCorr" or CorrName=="FSRUnf" or CorrName=="BornEffCorr":
  DataFile="/d2/scratch/khakim/WAnalysis/InclWZ_FinalEffSF/KoSMP/WAnalyzer/analysis/Unfolding/ResultWmToMuNu/Result_WmToMuNu.root"
