...
)
{
  ...
  //  f_Corr = new TFile("ElectronLowPU/Ele_WpToEleNu_S8_RecoilCorr.root");
    f_Org  = new TFile("ElectronLowPU/ElectronLowPU/Ele_DYToEE_S8_ScaleMakeMC_Eta_0.root");
    f_Corr = new TFile("ElectronLowPU/ElectronLowPU/Ele_RD_LowPU_ScaleMakeRD_Eta_0.root");
    }
  else if (filetype=="Minus")
    {
